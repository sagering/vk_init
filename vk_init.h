...
inline VkApplicationInfo vkiApplicationInfo(const char* pApplicationName, uint32_t applicationVersion, const char* pEngineName, uint32_t engineVersion, uint32_t apiVersion) {
...
inline VkInstanceCreateInfo vkiInstanceCreateInfo(const VkApplicationInfo* pApplicationInfo, uint32_t enabledLayerCount, const char* const* ppEnabledLayerNames, uint32_t enabledExtensionCount, const char* const* ppEnabledExtensionNames) {
...
inline VkAllocationCallbacks vkiAllocationCallbacks(void* pUserData, PFN_vkAllocationFunction pfnAllocation, PFN_vkReallocationFunction pfnReallocation, PFN_vkFreeFunction pfnFree, PFN_vkInternalAllocationNotification pfnInternalAllocation, PFN_vkInternalFreeNotification pfnInternalFree) {
...
inline VkPhysicalDeviceFeatures vkiPhysicalDeviceFeatures(VkBool32 robustBufferAccess, VkBool32 fullDrawIndexUint32, VkBool32 imageCubeArray, VkBool32 independentBlend, VkBool32 geometryShader, VkBool32 tessellationShader, VkBool32 sampleRateShading, VkBool32 dualSrcBlend, VkBool32 logicOp, VkBool32 multiDrawIndirect, VkBool32 drawIndirectFirstInstance, VkBool32 depthClamp, VkBool32 depthBiasClamp, VkBool32 fillModeNonSolid, VkBool32 depthBounds, VkBool32 wideLines, VkBool32 largePoints, VkBool32 alphaToOne, VkBool32 multiViewport, VkBool32 samplerAnisotropy, VkBool32 textureCompressionETC2, VkBool32 textureCompressionASTC_LDR, VkBool32 textureCompressionBC, VkBool32 occlusionQueryPrecise, VkBool32 pipelineStatisticsQuery, VkBool32 vertexPipelineStoresAndAtomics, VkBool32 fragmentStoresAndAtomics, VkBool32 shaderTessellationAndGeometryPointSize, VkBool32 shaderImageGatherExtended, VkBool32 shaderStorageImageExtendedFormats, VkBool32 shaderStorageImageMultisample, VkBool32 shaderStorageImageReadWithoutFormat, VkBool32 shaderStorageImageWriteWithoutFormat, VkBool32 shaderUniformBufferArrayDynamicIndexing, VkBool32 shaderSampledImageArrayDynamicIndexing, VkBool32 shaderStorageBufferArrayDynamicIndexing, VkBool32 shaderStorageImageArrayDynamicIndexing, VkBool32 shaderClipDistance, VkBool32 shaderCullDistance, VkBool32 shaderFloat64, VkBool32 shaderInt64, VkBool32 shaderInt16, VkBool32 shaderResourceResidency, VkBool32 shaderResourceMinLod, VkBool32 sparseBinding, VkBool32 sparseResidencyBuffer, VkBool32 sparseResidencyImage2D, VkBool32 sparseResidencyImage3D, VkBool32 sparseResidency2Samples, VkBool32 sparseResidency4Samples, VkBool32 sparseResidency8Samples, VkBool32 sparseResidency16Samples, VkBool32 sparseResidencyAliased, VkBool32 variableMultisampleRate, VkBool32 inheritedQueries) {
    ...
    PhysicalDeviceFeatures.textureCompressionASTC_LDR = textureCompressionASTC_LDR;
    ...
    PhysicalDeviceFeatures.vertexPipelineStoresAndAtomics = vertexPipelineStoresAndAtomics;
    PhysicalDeviceFeatures.fragmentStoresAndAtomics = fragmentStoresAndAtomics;
    PhysicalDeviceFeatures.shaderTessellationAndGeometryPointSize = shaderTessellationAndGeometryPointSize;
    PhysicalDeviceFeatures.shaderImageGatherExtended = shaderImageGatherExtended;
    PhysicalDeviceFeatures.shaderStorageImageExtendedFormats = shaderStorageImageExtendedFormats;
    PhysicalDeviceFeatures.shaderStorageImageMultisample = shaderStorageImageMultisample;
    PhysicalDeviceFeatures.shaderStorageImageReadWithoutFormat = shaderStorageImageReadWithoutFormat;
    PhysicalDeviceFeatures.shaderStorageImageWriteWithoutFormat = shaderStorageImageWriteWithoutFormat;
    PhysicalDeviceFeatures.shaderUniformBufferArrayDynamicIndexing = shaderUniformBufferArrayDynamicIndexing;
    PhysicalDeviceFeatures.shaderSampledImageArrayDynamicIndexing = shaderSampledImageArrayDynamicIndexing;
    PhysicalDeviceFeatures.shaderStorageBufferArrayDynamicIndexing = shaderStorageBufferArrayDynamicIndexing;
    PhysicalDeviceFeatures.shaderStorageImageArrayDynamicIndexing = shaderStorageImageArrayDynamicIndexing;
...
inline VkFormatProperties vkiFormatProperties(VkFormatFeatureFlags linearTilingFeatures, VkFormatFeatureFlags optimalTilingFeatures, VkFormatFeatureFlags bufferFeatures) {
...
inline VkImageFormatProperties vkiImageFormatProperties(VkExtent3D maxExtent, uint32_t maxMipLevels, uint32_t maxArrayLayers, VkSampleCountFlags sampleCounts, VkDeviceSize maxResourceSize) {
...
//     PhysicalDeviceLimits.maxSamplerAllocationCount = maxSamplerAllocationCount;
//     PhysicalDeviceLimits.bufferImageGranularity = bufferImageGranularity;
//     PhysicalDeviceLimits.sparseAddressSpaceSize = sparseAddressSpaceSize;
//     PhysicalDeviceLimits.maxBoundDescriptorSets = maxBoundDescriptorSets;
//     PhysicalDeviceLimits.maxPerStageDescriptorSamplers = maxPerStageDescriptorSamplers;
//     PhysicalDeviceLimits.maxPerStageDescriptorUniformBuffers = maxPerStageDescriptorUniformBuffers;
//     PhysicalDeviceLimits.maxPerStageDescriptorStorageBuffers = maxPerStageDescriptorStorageBuffers;
//     PhysicalDeviceLimits.maxPerStageDescriptorSampledImages = maxPerStageDescriptorSampledImages;
//     PhysicalDeviceLimits.maxPerStageDescriptorStorageImages = maxPerStageDescriptorStorageImages;
//     PhysicalDeviceLimits.maxPerStageDescriptorInputAttachments = maxPerStageDescriptorInputAttachments;
...
//     PhysicalDeviceLimits.maxDescriptorSetUniformBuffers = maxDescriptorSetUniformBuffers;
//     PhysicalDeviceLimits.maxDescriptorSetUniformBuffersDynamic = maxDescriptorSetUniformBuffersDynamic;
//     PhysicalDeviceLimits.maxDescriptorSetStorageBuffers = maxDescriptorSetStorageBuffers;
//     PhysicalDeviceLimits.maxDescriptorSetStorageBuffersDynamic = maxDescriptorSetStorageBuffersDynamic;
//     PhysicalDeviceLimits.maxDescriptorSetSampledImages = maxDescriptorSetSampledImages;
//     PhysicalDeviceLimits.maxDescriptorSetStorageImages = maxDescriptorSetStorageImages;
//     PhysicalDeviceLimits.maxDescriptorSetInputAttachments = maxDescriptorSetInputAttachments;
...
//     PhysicalDeviceLimits.maxVertexInputAttributeOffset = maxVertexInputAttributeOffset;
//     PhysicalDeviceLimits.maxVertexInputBindingStride = maxVertexInputBindingStride;
//     PhysicalDeviceLimits.maxVertexOutputComponents = maxVertexOutputComponents;
//     PhysicalDeviceLimits.maxTessellationGenerationLevel = maxTessellationGenerationLevel;
//     PhysicalDeviceLimits.maxTessellationPatchSize = maxTessellationPatchSize;
//     PhysicalDeviceLimits.maxTessellationControlPerVertexInputComponents = maxTessellationControlPerVertexInputComponents;
//     PhysicalDeviceLimits.maxTessellationControlPerVertexOutputComponents = maxTessellationControlPerVertexOutputComponents;
//     PhysicalDeviceLimits.maxTessellationControlPerPatchOutputComponents = maxTessellationControlPerPatchOutputComponents;
//     PhysicalDeviceLimits.maxTessellationControlTotalOutputComponents = maxTessellationControlTotalOutputComponents;
//     PhysicalDeviceLimits.maxTessellationEvaluationInputComponents = maxTessellationEvaluationInputComponents;
//     PhysicalDeviceLimits.maxTessellationEvaluationOutputComponents = maxTessellationEvaluationOutputComponents;
//     PhysicalDeviceLimits.maxGeometryShaderInvocations = maxGeometryShaderInvocations;
//     PhysicalDeviceLimits.maxGeometryInputComponents = maxGeometryInputComponents;
//     PhysicalDeviceLimits.maxGeometryOutputComponents = maxGeometryOutputComponents;
//     PhysicalDeviceLimits.maxGeometryOutputVertices = maxGeometryOutputVertices;
//     PhysicalDeviceLimits.maxGeometryTotalOutputComponents = maxGeometryTotalOutputComponents;
//     PhysicalDeviceLimits.maxFragmentInputComponents = maxFragmentInputComponents;
//     PhysicalDeviceLimits.maxFragmentOutputAttachments = maxFragmentOutputAttachments;
//     PhysicalDeviceLimits.maxFragmentDualSrcAttachments = maxFragmentDualSrcAttachments;
//     PhysicalDeviceLimits.maxFragmentCombinedOutputResources = maxFragmentCombinedOutputResources;
//     PhysicalDeviceLimits.maxComputeSharedMemorySize = maxComputeSharedMemorySize;
//     PhysicalDeviceLimits.maxComputeWorkGroupCount[3] = maxComputeWorkGroupCount[3];
//     PhysicalDeviceLimits.maxComputeWorkGroupInvocations = maxComputeWorkGroupInvocations;
//     PhysicalDeviceLimits.maxComputeWorkGroupSize[3] = maxComputeWorkGroupSize[3];
//     PhysicalDeviceLimits.subPixelPrecisionBits = subPixelPrecisionBits;
//     PhysicalDeviceLimits.subTexelPrecisionBits = subTexelPrecisionBits;
//     PhysicalDeviceLimits.mipmapPrecisionBits = mipmapPrecisionBits;
//     PhysicalDeviceLimits.maxDrawIndexedIndexValue = maxDrawIndexedIndexValue;
//     PhysicalDeviceLimits.maxDrawIndirectCount = maxDrawIndirectCount;
//     PhysicalDeviceLimits.maxSamplerLodBias = maxSamplerLodBias;
//     PhysicalDeviceLimits.maxSamplerAnisotropy = maxSamplerAnisotropy;
//     PhysicalDeviceLimits.maxViewports = maxViewports;
...
//     PhysicalDeviceLimits.minTexelBufferOffsetAlignment = minTexelBufferOffsetAlignment;
//     PhysicalDeviceLimits.minUniformBufferOffsetAlignment = minUniformBufferOffsetAlignment;
//     PhysicalDeviceLimits.minStorageBufferOffsetAlignment = minStorageBufferOffsetAlignment;
//     PhysicalDeviceLimits.minTexelOffset = minTexelOffset;
//     PhysicalDeviceLimits.maxTexelOffset = maxTexelOffset;
...
//     PhysicalDeviceLimits.subPixelInterpolationOffsetBits = subPixelInterpolationOffsetBits;
//     PhysicalDeviceLimits.maxFramebufferWidth = maxFramebufferWidth;
//     PhysicalDeviceLimits.maxFramebufferHeight = maxFramebufferHeight;
//     PhysicalDeviceLimits.maxFramebufferLayers = maxFramebufferLayers;
//     PhysicalDeviceLimits.framebufferColorSampleCounts = framebufferColorSampleCounts;
//     PhysicalDeviceLimits.framebufferDepthSampleCounts = framebufferDepthSampleCounts;
//     PhysicalDeviceLimits.framebufferStencilSampleCounts = framebufferStencilSampleCounts;
//     PhysicalDeviceLimits.framebufferNoAttachmentsSampleCounts = framebufferNoAttachmentsSampleCounts;
//     PhysicalDeviceLimits.maxColorAttachments = maxColorAttachments;
//     PhysicalDeviceLimits.sampledImageColorSampleCounts = sampledImageColorSampleCounts;
//     PhysicalDeviceLimits.sampledImageIntegerSampleCounts = sampledImageIntegerSampleCounts;
//     PhysicalDeviceLimits.sampledImageDepthSampleCounts = sampledImageDepthSampleCounts;
//     PhysicalDeviceLimits.sampledImageStencilSampleCounts = sampledImageStencilSampleCounts;
...
//     PhysicalDeviceLimits.timestampComputeAndGraphics = timestampComputeAndGraphics;
//     PhysicalDeviceLimits.timestampPeriod = timestampPeriod;
//     PhysicalDeviceLimits.maxClipDistances = maxClipDistances;
//     PhysicalDeviceLimits.maxCullDistances = maxCullDistances;
//     PhysicalDeviceLimits.maxCombinedClipAndCullDistances = maxCombinedClipAndCullDistances;
...
//     PhysicalDeviceLimits.optimalBufferCopyOffsetAlignment = optimalBufferCopyOffsetAlignment;
//     PhysicalDeviceLimits.optimalBufferCopyRowPitchAlignment = optimalBufferCopyRowPitchAlignment;
//     PhysicalDeviceLimits.nonCoherentAtomSize = nonCoherentAtomSize;
//     return PhysicalDeviceLimits;
// }

inline VkPhysicalDeviceSparseProperties vkiPhysicalDeviceSparseProperties(VkBool32 residencyStandard2DBlockShape, VkBool32 residencyStandard2DMultisampleBlockShape, VkBool32 residencyStandard3DBlockShape, VkBool32 residencyAlignedMipSize, VkBool32 residencyNonResidentStrict) {
    VkPhysicalDeviceSparseProperties PhysicalDeviceSparseProperties = {};
    PhysicalDeviceSparseProperties.residencyStandard2DBlockShape = residencyStandard2DBlockShape;
    PhysicalDeviceSparseProperties.residencyStandard2DMultisampleBlockShape = residencyStandard2DMultisampleBlockShape;
    PhysicalDeviceSparseProperties.residencyStandard3DBlockShape = residencyStandard3DBlockShape;
    PhysicalDeviceSparseProperties.residencyAlignedMipSize = residencyAlignedMipSize;
    PhysicalDeviceSparseProperties.residencyNonResidentStrict = residencyNonResidentStrict;
    return PhysicalDeviceSparseProperties;
}

// inline VkPhysicalDeviceProperties vkiPhysicalDeviceProperties(uint32_t apiVersion, uint32_t driverVersion, uint32_t vendorID, uint32_t deviceID, VkPhysicalDeviceType deviceType, char deviceName[VK_MAX_PHYSICAL_DEVICE_NAME_SIZE], uint8_t pipelineCacheUUID[VK_UUID_SIZE], VkPhysicalDeviceLimits limits, VkPhysicalDeviceSparseProperties sparseProperties) {
...
//     PhysicalDeviceProperties.deviceName[VK_MAX_PHYSICAL_DEVICE_NAME_SIZE] = deviceName[VK_MAX_PHYSICAL_DEVICE_NAME_SIZE];
//     PhysicalDeviceProperties.pipelineCacheUUID[VK_UUID_SIZE] = pipelineCacheUUID[VK_UUID_SIZE];
//     PhysicalDeviceProperties.limits = limits;
//     PhysicalDeviceProperties.sparseProperties = sparseProperties;
//     return PhysicalDeviceProperties;
// }

inline VkQueueFamilyProperties vkiQueueFamilyProperties(VkQueueFlags queueFlags, uint32_t queueCount, uint32_t timestampValidBits, VkExtent3D minImageTransferGranularity) {
...
inline VkMemoryType vkiMemoryType(VkMemoryPropertyFlags propertyFlags, uint32_t heapIndex) {
...
// inline VkPhysicalDeviceMemoryProperties vkiPhysicalDeviceMemoryProperties(uint32_t memoryTypeCount, VkMemoryType memoryTypes[VK_MAX_MEMORY_TYPES], uint32_t memoryHeapCount, VkMemoryHeap memoryHeaps[VK_MAX_MEMORY_HEAPS]) {
//     VkPhysicalDeviceMemoryProperties PhysicalDeviceMemoryProperties = {};
//     PhysicalDeviceMemoryProperties.memoryTypeCount = memoryTypeCount;
//     PhysicalDeviceMemoryProperties.memoryTypes[VK_MAX_MEMORY_TYPES] = memoryTypes[VK_MAX_MEMORY_TYPES];
//     PhysicalDeviceMemoryProperties.memoryHeapCount = memoryHeapCount;
//     PhysicalDeviceMemoryProperties.memoryHeaps[VK_MAX_MEMORY_HEAPS] = memoryHeaps[VK_MAX_MEMORY_HEAPS];
//     return PhysicalDeviceMemoryProperties;
// }

inline VkDeviceQueueCreateInfo vkiDeviceQueueCreateInfo(uint32_t queueFamilyIndex, uint32_t queueCount, const float* pQueuePriorities) {
...
inline VkDeviceCreateInfo vkiDeviceCreateInfo(uint32_t queueCreateInfoCount, const VkDeviceQueueCreateInfo* pQueueCreateInfos, uint32_t enabledLayerCount, const char* const* ppEnabledLayerNames, uint32_t enabledExtensionCount, const char* const* ppEnabledExtensionNames, const VkPhysicalDeviceFeatures* pEnabledFeatures) {
...
// inline VkExtensionProperties vkiExtensionProperties(char extensionName[VK_MAX_EXTENSION_NAME_SIZE], uint32_t specVersion) {
//     VkExtensionProperties ExtensionProperties = {};
//     ExtensionProperties.extensionName[VK_MAX_EXTENSION_NAME_SIZE] = extensionName[VK_MAX_EXTENSION_NAME_SIZE];
//     ExtensionProperties.specVersion = specVersion;
//     return ExtensionProperties;
// }

// inline VkLayerProperties vkiLayerProperties(char layerName[VK_MAX_EXTENSION_NAME_SIZE], uint32_t specVersion, uint32_t implementationVersion, char description[VK_MAX_DESCRIPTION_SIZE]) {
//     VkLayerProperties LayerProperties = {};
//     LayerProperties.layerName[VK_MAX_EXTENSION_NAME_SIZE] = layerName[VK_MAX_EXTENSION_NAME_SIZE];
//     LayerProperties.specVersion = specVersion;
//     LayerProperties.implementationVersion = implementationVersion;
//     LayerProperties.description[VK_MAX_DESCRIPTION_SIZE] = description[VK_MAX_DESCRIPTION_SIZE];
//     return LayerProperties;
// }

inline VkSubmitInfo vkiSubmitInfo(uint32_t waitSemaphoreCount, const VkSemaphore* pWaitSemaphores, const VkPipelineStageFlags* pWaitDstStageMask, uint32_t commandBufferCount, const VkCommandBuffer* pCommandBuffers, uint32_t signalSemaphoreCount, const VkSemaphore* pSignalSemaphores) {
...
inline VkMemoryAllocateInfo vkiMemoryAllocateInfo(VkDeviceSize allocationSize, uint32_t memoryTypeIndex) {
...
inline VkMappedMemoryRange vkiMappedMemoryRange(VkDeviceMemory memory, VkDeviceSize offset, VkDeviceSize size) {
...
inline VkMemoryRequirements vkiMemoryRequirements(VkDeviceSize size, VkDeviceSize alignment, uint32_t memoryTypeBits) {
...
inline VkSparseImageFormatProperties vkiSparseImageFormatProperties(VkImageAspectFlags aspectMask, VkExtent3D imageGranularity) {
...
inline VkSparseImageMemoryRequirements vkiSparseImageMemoryRequirements(VkSparseImageFormatProperties formatProperties, uint32_t imageMipTailFirstLod, VkDeviceSize imageMipTailSize, VkDeviceSize imageMipTailOffset, VkDeviceSize imageMipTailStride) {
...
inline VkSparseMemoryBind vkiSparseMemoryBind(VkDeviceSize resourceOffset, VkDeviceSize size, VkDeviceMemory memory, VkDeviceSize memoryOffset) {
...
inline VkSparseBufferMemoryBindInfo vkiSparseBufferMemoryBindInfo(VkBuffer buffer, uint32_t bindCount, const VkSparseMemoryBind* pBinds) {
...
inline VkSparseImageOpaqueMemoryBindInfo vkiSparseImageOpaqueMemoryBindInfo(VkImage image, uint32_t bindCount, const VkSparseMemoryBind* pBinds) {
...
inline VkImageSubresource vkiImageSubresource(VkImageAspectFlags aspectMask, uint32_t mipLevel, uint32_t arrayLayer) {
...
inline VkSparseImageMemoryBind vkiSparseImageMemoryBind(VkImageSubresource subresource, VkOffset3D offset, VkExtent3D extent, VkDeviceMemory memory, VkDeviceSize memoryOffset) {
...
inline VkSparseImageMemoryBindInfo vkiSparseImageMemoryBindInfo(VkImage image, uint32_t bindCount, const VkSparseImageMemoryBind* pBinds) {
...
inline VkQueryPoolCreateInfo vkiQueryPoolCreateInfo(VkQueryType queryType, uint32_t queryCount, VkQueryPipelineStatisticFlags pipelineStatistics) {
...
inline VkBufferCreateInfo vkiBufferCreateInfo(VkDeviceSize size, VkBufferUsageFlags usage, VkSharingMode sharingMode, uint32_t queueFamilyIndexCount, const uint32_t* pQueueFamilyIndices) {
...
inline VkBufferViewCreateInfo vkiBufferViewCreateInfo(VkBuffer buffer, VkFormat format, VkDeviceSize offset, VkDeviceSize range) {
...
inline VkImageCreateInfo vkiImageCreateInfo(VkImageType imageType, VkFormat format, VkExtent3D extent, uint32_t mipLevels, uint32_t arrayLayers, VkSampleCountFlagBits samples, VkImageTiling tiling, VkImageUsageFlags usage, VkSharingMode sharingMode, uint32_t queueFamilyIndexCount, const uint32_t* pQueueFamilyIndices, VkImageLayout initialLayout) {
...
inline VkSubresourceLayout vkiSubresourceLayout(VkDeviceSize offset, VkDeviceSize size, VkDeviceSize rowPitch, VkDeviceSize arrayPitch, VkDeviceSize depthPitch) {
...
inline VkComponentMapping vkiComponentMapping(VkComponentSwizzle r, VkComponentSwizzle g, VkComponentSwizzle b, VkComponentSwizzle a) {
...
inline VkImageSubresourceRange vkiImageSubresourceRange(VkImageAspectFlags aspectMask, uint32_t baseMipLevel, uint32_t levelCount, uint32_t baseArrayLayer, uint32_t layerCount) {
...
inline VkImageViewCreateInfo vkiImageViewCreateInfo(VkImage image, VkImageViewType viewType, VkFormat format, VkComponentMapping components, VkImageSubresourceRange subresourceRange) {
...
inline VkShaderModuleCreateInfo vkiShaderModuleCreateInfo(size_t codeSize, const uint32_t* pCode) {
...
inline VkPipelineCacheCreateInfo vkiPipelineCacheCreateInfo(size_t initialDataSize, const void* pInitialData) {
...
inline VkSpecializationMapEntry vkiSpecializationMapEntry(uint32_t constantID, uint32_t offset, size_t size) {
...
inline VkSpecializationInfo vkiSpecializationInfo(uint32_t mapEntryCount, const VkSpecializationMapEntry* pMapEntries, size_t dataSize, const void* pData) {
...
inline VkPipelineShaderStageCreateInfo vkiPipelineShaderStageCreateInfo(VkShaderStageFlagBits stage, VkShaderModule module, const char* pName, const VkSpecializationInfo* pSpecializationInfo) {
...
inline VkVertexInputBindingDescription vkiVertexInputBindingDescription(uint32_t binding, uint32_t stride, VkVertexInputRate inputRate) {
...
inline VkVertexInputAttributeDescription vkiVertexInputAttributeDescription(uint32_t location, uint32_t binding, VkFormat format, uint32_t offset) {
...
inline VkPipelineVertexInputStateCreateInfo vkiPipelineVertexInputStateCreateInfo(uint32_t vertexBindingDescriptionCount, const VkVertexInputBindingDescription* pVertexBindingDescriptions, uint32_t vertexAttributeDescriptionCount, const VkVertexInputAttributeDescription* pVertexAttributeDescriptions) {
...
inline VkPipelineInputAssemblyStateCreateInfo vkiPipelineInputAssemblyStateCreateInfo(VkPrimitiveTopology topology, VkBool32 primitiveRestartEnable) {
...
inline VkPipelineTessellationStateCreateInfo vkiPipelineTessellationStateCreateInfo(uint32_t patchControlPoints) {
...
inline VkViewport vkiViewport(float x, float y, float width, float height, float minDepth, float maxDepth) {
    VkViewport Viewport = {};
    Viewport.x = x;
    Viewport.y = y;
...
inline VkPipelineViewportStateCreateInfo vkiPipelineViewportStateCreateInfo(uint32_t viewportCount, const VkViewport* pViewports, uint32_t scissorCount, const VkRect2D* pScissors) {
...
inline VkPipelineMultisampleStateCreateInfo vkiPipelineMultisampleStateCreateInfo(VkSampleCountFlagBits rasterizationSamples, VkBool32 sampleShadingEnable, float minSampleShading, const VkSampleMask* pSampleMask, VkBool32 alphaToCoverageEnable, VkBool32 alphaToOneEnable) {
...
inline VkStencilOpState vkiStencilOpState(VkStencilOp failOp, VkStencilOp passOp, VkStencilOp depthFailOp, VkCompareOp compareOp, uint32_t compareMask, uint32_t writeMask, uint32_t reference) {
...
inline VkPipelineDepthStencilStateCreateInfo vkiPipelineDepthStencilStateCreateInfo(VkBool32 depthTestEnable, VkBool32 depthWriteEnable, VkCompareOp depthCompareOp, VkBool32 depthBoundsTestEnable, VkBool32 stencilTestEnable, VkStencilOpState front, VkStencilOpState back, float minDepthBounds, float maxDepthBounds) {
...
// inline VkPipelineColorBlendStateCreateInfo vkiPipelineColorBlendStateCreateInfo(VkBool32 logicOpEnable, VkLogicOp logicOp, uint32_t attachmentCount, const VkPipelineColorBlendAttachmentState* pAttachments, float blendConstants[4]) {
...
inline VkPipelineDynamicStateCreateInfo vkiPipelineDynamicStateCreateInfo(uint32_t dynamicStateCount, const VkDynamicState* pDynamicStates) {
...
inline VkComputePipelineCreateInfo vkiComputePipelineCreateInfo(VkPipelineShaderStageCreateInfo stage, VkPipelineLayout layout, VkPipeline basePipelineHandle, int32_t basePipelineIndex) {
...
inline VkPushConstantRange vkiPushConstantRange(VkShaderStageFlags stageFlags, uint32_t offset, uint32_t size) {
...
inline VkPipelineLayoutCreateInfo vkiPipelineLayoutCreateInfo(uint32_t setLayoutCount, const VkDescriptorSetLayout* pSetLayouts, uint32_t pushConstantRangeCount, const VkPushConstantRange* pPushConstantRanges) {
...
inline VkSamplerCreateInfo vkiSamplerCreateInfo(VkFilter magFilter, VkFilter minFilter, VkSamplerMipmapMode mipmapMode, VkSamplerAddressMode addressModeU, VkSamplerAddressMode addressModeV, VkSamplerAddressMode addressModeW, float mipLodBias, VkBool32 anisotropyEnable, float maxAnisotropy, VkBool32 compareEnable, VkCompareOp compareOp, float minLod, float maxLod, VkBorderColor borderColor, VkBool32 unnormalizedCoordinates) {
...
inline VkDescriptorSetLayoutBinding vkiDescriptorSetLayoutBinding(uint32_t binding, VkDescriptorType descriptorType, uint32_t descriptorCount, VkShaderStageFlags stageFlags, const VkSampler* pImmutableSamplers) {
...
inline VkDescriptorSetLayoutCreateInfo vkiDescriptorSetLayoutCreateInfo(uint32_t bindingCount, const VkDescriptorSetLayoutBinding* pBindings) {
...
inline VkDescriptorPoolSize vkiDescriptorPoolSize(VkDescriptorType type, uint32_t descriptorCount) {
...
inline VkDescriptorPoolCreateInfo vkiDescriptorPoolCreateInfo(uint32_t maxSets, uint32_t poolSizeCount, const VkDescriptorPoolSize* pPoolSizes) {
...
inline VkDescriptorSetAllocateInfo vkiDescriptorSetAllocateInfo(VkDescriptorPool descriptorPool, uint32_t descriptorSetCount, const VkDescriptorSetLayout* pSetLayouts) {
...
inline VkDescriptorImageInfo vkiDescriptorImageInfo(VkSampler sampler, VkImageView imageView, VkImageLayout imageLayout) {
...
inline VkDescriptorBufferInfo vkiDescriptorBufferInfo(VkBuffer buffer, VkDeviceSize offset, VkDeviceSize range) {
...
inline VkWriteDescriptorSet vkiWriteDescriptorSet(VkDescriptorSet dstSet, uint32_t dstBinding, uint32_t dstArrayElement, uint32_t descriptorCount, VkDescriptorType descriptorType, const VkDescriptorImageInfo* pImageInfo, const VkDescriptorBufferInfo* pBufferInfo, const VkBufferView* pTexelBufferView) {
...
inline VkCopyDescriptorSet vkiCopyDescriptorSet(VkDescriptorSet srcSet, uint32_t srcBinding, uint32_t srcArrayElement, VkDescriptorSet dstSet, uint32_t dstBinding, uint32_t dstArrayElement, uint32_t descriptorCount) {
...
inline VkFramebufferCreateInfo vkiFramebufferCreateInfo(VkRenderPass renderPass, uint32_t attachmentCount, const VkImageView* pAttachments, uint32_t width, uint32_t height, uint32_t layers) {
...
inline VkAttachmentDescription vkiAttachmentDescription(VkFormat format, VkSampleCountFlagBits samples, VkAttachmentLoadOp loadOp, VkAttachmentStoreOp storeOp, VkAttachmentLoadOp stencilLoadOp, VkAttachmentStoreOp stencilStoreOp, VkImageLayout initialLayout, VkImageLayout finalLayout) {
...
inline VkAttachmentReference vkiAttachmentReference(uint32_t attachment, VkImageLayout layout) {
...
inline VkSubpassDescription vkiSubpassDescription(VkPipelineBindPoint pipelineBindPoint, uint32_t inputAttachmentCount, const VkAttachmentReference* pInputAttachments, uint32_t colorAttachmentCount, const VkAttachmentReference* pColorAttachments, const VkAttachmentReference* pResolveAttachments, const VkAttachmentReference* pDepthStencilAttachment, uint32_t preserveAttachmentCount, const uint32_t* pPreserveAttachments) {
...
inline VkSubpassDependency vkiSubpassDependency(uint32_t srcSubpass, uint32_t dstSubpass, VkPipelineStageFlags srcStageMask, VkPipelineStageFlags dstStageMask, VkAccessFlags srcAccessMask, VkAccessFlags dstAccessMask, VkDependencyFlags dependencyFlags) {
...
inline VkRenderPassCreateInfo vkiRenderPassCreateInfo(uint32_t attachmentCount, const VkAttachmentDescription* pAttachments, uint32_t subpassCount, const VkSubpassDescription* pSubpasses, uint32_t dependencyCount, const VkSubpassDependency* pDependencies) {
...
inline VkCommandPoolCreateInfo vkiCommandPoolCreateInfo(uint32_t queueFamilyIndex) {
...
inline VkCommandBufferAllocateInfo vkiCommandBufferAllocateInfo(VkCommandPool commandPool, VkCommandBufferLevel level, uint32_t commandBufferCount) {
...
inline VkCommandBufferInheritanceInfo vkiCommandBufferInheritanceInfo(VkRenderPass renderPass, uint32_t subpass, VkFramebuffer framebuffer, VkBool32 occlusionQueryEnable, VkQueryControlFlags queryFlags, VkQueryPipelineStatisticFlags pipelineStatistics) {
...
inline VkCommandBufferBeginInfo vkiCommandBufferBeginInfo(const VkCommandBufferInheritanceInfo* pInheritanceInfo) {
...
inline VkBufferCopy vkiBufferCopy(VkDeviceSize srcOffset, VkDeviceSize dstOffset, VkDeviceSize size) {
...
inline VkImageSubresourceLayers vkiImageSubresourceLayers(VkImageAspectFlags aspectMask, uint32_t mipLevel, uint32_t baseArrayLayer, uint32_t layerCount) {
...
inline VkImageCopy vkiImageCopy(VkImageSubresourceLayers srcSubresource, VkOffset3D srcOffset, VkImageSubresourceLayers dstSubresource, VkOffset3D dstOffset, VkExtent3D extent) {
...
// inline VkImageBlit vkiImageBlit(VkImageSubresourceLayers srcSubresource, VkOffset3D srcOffsets[2], VkImageSubresourceLayers dstSubresource, VkOffset3D dstOffsets[2]) {
...
inline VkBufferImageCopy vkiBufferImageCopy(VkDeviceSize bufferOffset, uint32_t bufferRowLength, uint32_t bufferImageHeight, VkImageSubresourceLayers imageSubresource, VkOffset3D imageOffset, VkExtent3D imageExtent) {
...
inline VkClearDepthStencilValue vkiClearDepthStencilValue(float depth, uint32_t stencil) {
...
inline VkClearAttachment vkiClearAttachment(VkImageAspectFlags aspectMask, uint32_t colorAttachment, VkClearValue clearValue) {
...
inline VkClearRect vkiClearRect(VkRect2D rect, uint32_t baseArrayLayer, uint32_t layerCount) {
...
inline VkImageResolve vkiImageResolve(VkImageSubresourceLayers srcSubresource, VkOffset3D srcOffset, VkImageSubresourceLayers dstSubresource, VkOffset3D dstOffset, VkExtent3D extent) {
...
inline VkMemoryBarrier vkiMemoryBarrier(VkAccessFlags srcAccessMask, VkAccessFlags dstAccessMask) {
...
inline VkBufferMemoryBarrier vkiBufferMemoryBarrier(VkAccessFlags srcAccessMask, VkAccessFlags dstAccessMask, uint32_t srcQueueFamilyIndex, uint32_t dstQueueFamilyIndex, VkBuffer buffer, VkDeviceSize offset, VkDeviceSize size) {
...
inline VkImageMemoryBarrier vkiImageMemoryBarrier(VkAccessFlags srcAccessMask, VkAccessFlags dstAccessMask, VkImageLayout oldLayout, VkImageLayout newLayout, uint32_t srcQueueFamilyIndex, uint32_t dstQueueFamilyIndex, VkImage image, VkImageSubresourceRange subresourceRange) {
...
inline VkRenderPassBeginInfo vkiRenderPassBeginInfo(VkRenderPass renderPass, VkFramebuffer framebuffer, VkRect2D renderArea, uint32_t clearValueCount, const VkClearValue* pClearValues) {
...
inline VkDispatchIndirectCommand vkiDispatchIndirectCommand(uint32_t x, uint32_t y, uint32_t z) {
...
inline VkDrawIndexedIndirectCommand vkiDrawIndexedIndirectCommand(uint32_t indexCount, uint32_t instanceCount, uint32_t firstIndex, int32_t vertexOffset, uint32_t firstInstance) {
...
inline VkDrawIndirectCommand vkiDrawIndirectCommand(uint32_t vertexCount, uint32_t instanceCount, uint32_t firstVertex, uint32_t firstInstance) {
...
inline VkPhysicalDeviceSubgroupProperties vkiPhysicalDeviceSubgroupProperties(uint32_t subgroupSize, VkShaderStageFlags supportedStages, VkSubgroupFeatureFlags supportedOperations, VkBool32 quadOperationsInAllStages) {
    ...
    PhysicalDeviceSubgroupProperties.quadOperationsInAllStages = quadOperationsInAllStages;
    return PhysicalDeviceSubgroupProperties;
}

inline VkBindBufferMemoryInfo vkiBindBufferMemoryInfo(VkBuffer buffer, VkDeviceMemory memory, VkDeviceSize memoryOffset) {
...
inline VkBindImageMemoryInfo vkiBindImageMemoryInfo(VkImage image, VkDeviceMemory memory, VkDeviceSize memoryOffset) {
...
inline VkPhysicalDevice16BitStorageFeatures vkiPhysicalDevice16BitStorageFeatures(VkBool32 storageBuffer16BitAccess, VkBool32 uniformAndStorageBuffer16BitAccess, VkBool32 storagePushConstant16, VkBool32 storageInputOutput16) {
    ...
    PhysicalDevice16BitStorageFeatures.storageBuffer16BitAccess = storageBuffer16BitAccess;
    PhysicalDevice16BitStorageFeatures.uniformAndStorageBuffer16BitAccess = uniformAndStorageBuffer16BitAccess;
    PhysicalDevice16BitStorageFeatures.storagePushConstant16 = storagePushConstant16;
    PhysicalDevice16BitStorageFeatures.storageInputOutput16 = storageInputOutput16;
    return PhysicalDevice16BitStorageFeatures;
}

inline VkMemoryDedicatedRequirements vkiMemoryDedicatedRequirements(VkBool32 prefersDedicatedAllocation, VkBool32 requiresDedicatedAllocation) {
    ...
    MemoryDedicatedRequirements.prefersDedicatedAllocation = prefersDedicatedAllocation;
    MemoryDedicatedRequirements.requiresDedicatedAllocation = requiresDedicatedAllocation;
    return MemoryDedicatedRequirements;
}

inline VkMemoryDedicatedAllocateInfo vkiMemoryDedicatedAllocateInfo(VkImage image, VkBuffer buffer) {
...
inline VkMemoryAllocateFlagsInfo vkiMemoryAllocateFlagsInfo(uint32_t deviceMask) {
...
inline VkDeviceGroupRenderPassBeginInfo vkiDeviceGroupRenderPassBeginInfo(uint32_t deviceMask, uint32_t deviceRenderAreaCount, const VkRect2D* pDeviceRenderAreas) {
...
inline VkDeviceGroupCommandBufferBeginInfo vkiDeviceGroupCommandBufferBeginInfo(uint32_t deviceMask) {
...
inline VkDeviceGroupSubmitInfo vkiDeviceGroupSubmitInfo(uint32_t waitSemaphoreCount, const uint32_t* pWaitSemaphoreDeviceIndices, uint32_t commandBufferCount, const uint32_t* pCommandBufferDeviceMasks, uint32_t signalSemaphoreCount, const uint32_t* pSignalSemaphoreDeviceIndices) {
    ...
    DeviceGroupSubmitInfo.pWaitSemaphoreDeviceIndices = pWaitSemaphoreDeviceIndices;
    ...
    DeviceGroupSubmitInfo.pSignalSemaphoreDeviceIndices = pSignalSemaphoreDeviceIndices;
    return DeviceGroupSubmitInfo;
}

inline VkDeviceGroupBindSparseInfo vkiDeviceGroupBindSparseInfo(uint32_t resourceDeviceIndex, uint32_t memoryDeviceIndex) {
...
inline VkBindBufferMemoryDeviceGroupInfo vkiBindBufferMemoryDeviceGroupInfo(uint32_t deviceIndexCount, const uint32_t* pDeviceIndices) {
...
inline VkBindImageMemoryDeviceGroupInfo vkiBindImageMemoryDeviceGroupInfo(uint32_t deviceIndexCount, const uint32_t* pDeviceIndices, uint32_t splitInstanceBindRegionCount, const VkRect2D* pSplitInstanceBindRegions) {
    ...
    BindImageMemoryDeviceGroupInfo.splitInstanceBindRegionCount = splitInstanceBindRegionCount;
    BindImageMemoryDeviceGroupInfo.pSplitInstanceBindRegions = pSplitInstanceBindRegions;
    return BindImageMemoryDeviceGroupInfo;
}

// inline VkPhysicalDeviceGroupProperties vkiPhysicalDeviceGroupProperties(uint32_t physicalDeviceCount, VkPhysicalDevice physicalDevices[VK_MAX_DEVICE_GROUP_SIZE], VkBool32 subsetAllocation) {
...
//     PhysicalDeviceGroupProperties.physicalDevices[VK_MAX_DEVICE_GROUP_SIZE] = physicalDevices[VK_MAX_DEVICE_GROUP_SIZE];
//     PhysicalDeviceGroupProperties.subsetAllocation = subsetAllocation;
//     return PhysicalDeviceGroupProperties;
// }

inline VkDeviceGroupDeviceCreateInfo vkiDeviceGroupDeviceCreateInfo(uint32_t physicalDeviceCount, const VkPhysicalDevice* pPhysicalDevices) {
...
inline VkBufferMemoryRequirementsInfo2 vkiBufferMemoryRequirementsInfo2(VkBuffer buffer) {
...
inline VkImageMemoryRequirementsInfo2 vkiImageMemoryRequirementsInfo2(VkImage image) {
...
inline VkImageSparseMemoryRequirementsInfo2 vkiImageSparseMemoryRequirementsInfo2(VkImage image) {
...
inline VkMemoryRequirements2 vkiMemoryRequirements2(VkMemoryRequirements memoryRequirements) {
...
inline VkSparseImageMemoryRequirements2 vkiSparseImageMemoryRequirements2(VkSparseImageMemoryRequirements memoryRequirements) {
...
inline VkPhysicalDeviceFeatures2 vkiPhysicalDeviceFeatures2(VkPhysicalDeviceFeatures features) {
...
inline VkPhysicalDeviceProperties2 vkiPhysicalDeviceProperties2(VkPhysicalDeviceProperties properties) {
...
inline VkFormatProperties2 vkiFormatProperties2(VkFormatProperties formatProperties) {
...
inline VkImageFormatProperties2 vkiImageFormatProperties2(VkImageFormatProperties imageFormatProperties) {
...
inline VkPhysicalDeviceImageFormatInfo2 vkiPhysicalDeviceImageFormatInfo2(VkFormat format, VkImageType type, VkImageTiling tiling, VkImageUsageFlags usage) {
...
inline VkQueueFamilyProperties2 vkiQueueFamilyProperties2(VkQueueFamilyProperties queueFamilyProperties) {
...
inline VkPhysicalDeviceMemoryProperties2 vkiPhysicalDeviceMemoryProperties2(VkPhysicalDeviceMemoryProperties memoryProperties) {
...
inline VkSparseImageFormatProperties2 vkiSparseImageFormatProperties2(VkSparseImageFormatProperties properties) {
...
inline VkPhysicalDeviceSparseImageFormatInfo2 vkiPhysicalDeviceSparseImageFormatInfo2(VkFormat format, VkImageType type, VkSampleCountFlagBits samples, VkImageUsageFlags usage, VkImageTiling tiling) {
...
inline VkPhysicalDevicePointClippingProperties vkiPhysicalDevicePointClippingProperties(VkPointClippingBehavior pointClippingBehavior) {
    ...
    PhysicalDevicePointClippingProperties.pointClippingBehavior = pointClippingBehavior;
    return PhysicalDevicePointClippingProperties;
}

inline VkInputAttachmentAspectReference vkiInputAttachmentAspectReference(uint32_t subpass, uint32_t inputAttachmentIndex, VkImageAspectFlags aspectMask) {
...
inline VkRenderPassInputAttachmentAspectCreateInfo vkiRenderPassInputAttachmentAspectCreateInfo(uint32_t aspectReferenceCount, const VkInputAttachmentAspectReference* pAspectReferences) {
    ...
    RenderPassInputAttachmentAspectCreateInfo.aspectReferenceCount = aspectReferenceCount;
    RenderPassInputAttachmentAspectCreateInfo.pAspectReferences = pAspectReferences;
    return RenderPassInputAttachmentAspectCreateInfo;
}

inline VkImageViewUsageCreateInfo vkiImageViewUsageCreateInfo(VkImageUsageFlags usage) {
...
inline VkPipelineTessellationDomainOriginStateCreateInfo vkiPipelineTessellationDomainOriginStateCreateInfo(VkTessellationDomainOrigin domainOrigin) {
...
inline VkRenderPassMultiviewCreateInfo vkiRenderPassMultiviewCreateInfo(uint32_t subpassCount, const uint32_t* pViewMasks, uint32_t dependencyCount, const int32_t* pViewOffsets, uint32_t correlationMaskCount, const uint32_t* pCorrelationMasks) {
...
inline VkPhysicalDeviceMultiviewFeatures vkiPhysicalDeviceMultiviewFeatures(VkBool32 multiview, VkBool32 multiviewGeometryShader, VkBool32 multiviewTessellationShader) {
    ...
    PhysicalDeviceMultiviewFeatures.multiviewGeometryShader = multiviewGeometryShader;
    PhysicalDeviceMultiviewFeatures.multiviewTessellationShader = multiviewTessellationShader;
    return PhysicalDeviceMultiviewFeatures;
}

inline VkPhysicalDeviceMultiviewProperties vkiPhysicalDeviceMultiviewProperties(uint32_t maxMultiviewViewCount, uint32_t maxMultiviewInstanceIndex) {
    ...
    PhysicalDeviceMultiviewProperties.maxMultiviewViewCount = maxMultiviewViewCount;
    PhysicalDeviceMultiviewProperties.maxMultiviewInstanceIndex = maxMultiviewInstanceIndex;
    return PhysicalDeviceMultiviewProperties;
}

inline VkPhysicalDeviceVariablePointersFeatures vkiPhysicalDeviceVariablePointersFeatures(VkBool32 variablePointersStorageBuffer, VkBool32 variablePointers) {
    ...
    PhysicalDeviceVariablePointersFeatures.variablePointersStorageBuffer = variablePointersStorageBuffer;
    PhysicalDeviceVariablePointersFeatures.variablePointers = variablePointers;
    return PhysicalDeviceVariablePointersFeatures;
}

inline VkPhysicalDeviceProtectedMemoryFeatures vkiPhysicalDeviceProtectedMemoryFeatures(VkBool32 protectedMemory) {
...
inline VkPhysicalDeviceProtectedMemoryProperties vkiPhysicalDeviceProtectedMemoryProperties(VkBool32 protectedNoFault) {
...
inline VkDeviceQueueInfo2 vkiDeviceQueueInfo2(uint32_t queueFamilyIndex, uint32_t queueIndex) {
...
inline VkSamplerYcbcrConversionCreateInfo vkiSamplerYcbcrConversionCreateInfo(VkFormat format, VkSamplerYcbcrModelConversion ycbcrModel, VkSamplerYcbcrRange ycbcrRange, VkComponentMapping components, VkChromaLocation xChromaOffset, VkChromaLocation yChromaOffset, VkFilter chromaFilter, VkBool32 forceExplicitReconstruction) {
    ...
    SamplerYcbcrConversionCreateInfo.forceExplicitReconstruction = forceExplicitReconstruction;
    return SamplerYcbcrConversionCreateInfo;
}

inline VkSamplerYcbcrConversionInfo vkiSamplerYcbcrConversionInfo(VkSamplerYcbcrConversion conversion) {
...
inline VkBindImagePlaneMemoryInfo vkiBindImagePlaneMemoryInfo(VkImageAspectFlagBits planeAspect) {
...
inline VkImagePlaneMemoryRequirementsInfo vkiImagePlaneMemoryRequirementsInfo(VkImageAspectFlagBits planeAspect) {
...
inline VkPhysicalDeviceSamplerYcbcrConversionFeatures vkiPhysicalDeviceSamplerYcbcrConversionFeatures(VkBool32 samplerYcbcrConversion) {
    ...
    PhysicalDeviceSamplerYcbcrConversionFeatures.samplerYcbcrConversion = samplerYcbcrConversion;
    return PhysicalDeviceSamplerYcbcrConversionFeatures;
}

inline VkSamplerYcbcrConversionImageFormatProperties vkiSamplerYcbcrConversionImageFormatProperties(uint32_t combinedImageSamplerDescriptorCount) {
    ...
    SamplerYcbcrConversionImageFormatProperties.combinedImageSamplerDescriptorCount = combinedImageSamplerDescriptorCount;
    return SamplerYcbcrConversionImageFormatProperties;
}

inline VkDescriptorUpdateTemplateEntry vkiDescriptorUpdateTemplateEntry(uint32_t dstBinding, uint32_t dstArrayElement, uint32_t descriptorCount, VkDescriptorType descriptorType, size_t offset, size_t stride) {
...
inline VkDescriptorUpdateTemplateCreateInfo vkiDescriptorUpdateTemplateCreateInfo(uint32_t descriptorUpdateEntryCount, const VkDescriptorUpdateTemplateEntry* pDescriptorUpdateEntries, VkDescriptorUpdateTemplateType templateType, VkDescriptorSetLayout descriptorSetLayout, VkPipelineBindPoint pipelineBindPoint, VkPipelineLayout pipelineLayout, uint32_t set) {
    ...
    DescriptorUpdateTemplateCreateInfo.descriptorUpdateEntryCount = descriptorUpdateEntryCount;
    DescriptorUpdateTemplateCreateInfo.pDescriptorUpdateEntries = pDescriptorUpdateEntries;
...
inline VkExternalMemoryProperties vkiExternalMemoryProperties(VkExternalMemoryFeatureFlags externalMemoryFeatures, VkExternalMemoryHandleTypeFlags exportFromImportedHandleTypes, VkExternalMemoryHandleTypeFlags compatibleHandleTypes) {
    VkExternalMemoryProperties ExternalMemoryProperties = {};
    ExternalMemoryProperties.externalMemoryFeatures = externalMemoryFeatures;
    ExternalMemoryProperties.exportFromImportedHandleTypes = exportFromImportedHandleTypes;
    ExternalMemoryProperties.compatibleHandleTypes = compatibleHandleTypes;
    return ExternalMemoryProperties;
}

inline VkPhysicalDeviceExternalImageFormatInfo vkiPhysicalDeviceExternalImageFormatInfo(VkExternalMemoryHandleTypeFlagBits handleType) {
...
inline VkExternalImageFormatProperties vkiExternalImageFormatProperties(VkExternalMemoryProperties externalMemoryProperties) {
    ...
    ExternalImageFormatProperties.externalMemoryProperties = externalMemoryProperties;
    return ExternalImageFormatProperties;
}

inline VkPhysicalDeviceExternalBufferInfo vkiPhysicalDeviceExternalBufferInfo(VkBufferUsageFlags usage, VkExternalMemoryHandleTypeFlagBits handleType) {
...
inline VkExternalBufferProperties vkiExternalBufferProperties(VkExternalMemoryProperties externalMemoryProperties) {
...
// inline VkPhysicalDeviceIDProperties vkiPhysicalDeviceIDProperties(uint8_t deviceUUID[VK_UUID_SIZE], uint8_t driverUUID[VK_UUID_SIZE], uint8_t deviceLUID[VK_LUID_SIZE], uint32_t deviceNodeMask, VkBool32 deviceLUIDValid) {
//     VkPhysicalDeviceIDProperties PhysicalDeviceIDProperties = {};
//     PhysicalDeviceIDProperties.sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ID_PROPERTIES;
//     PhysicalDeviceIDProperties.pNext = nullptr;
//     PhysicalDeviceIDProperties.deviceUUID[VK_UUID_SIZE] = deviceUUID[VK_UUID_SIZE];
//     PhysicalDeviceIDProperties.driverUUID[VK_UUID_SIZE] = driverUUID[VK_UUID_SIZE];
//     PhysicalDeviceIDProperties.deviceLUID[VK_LUID_SIZE] = deviceLUID[VK_LUID_SIZE];
//     PhysicalDeviceIDProperties.deviceNodeMask = deviceNodeMask;
//     PhysicalDeviceIDProperties.deviceLUIDValid = deviceLUIDValid;
//     return PhysicalDeviceIDProperties;
// }

inline VkExternalMemoryImageCreateInfo vkiExternalMemoryImageCreateInfo(VkExternalMemoryHandleTypeFlags handleTypes) {
...
inline VkExternalMemoryBufferCreateInfo vkiExternalMemoryBufferCreateInfo(VkExternalMemoryHandleTypeFlags handleTypes) {
...
inline VkExportMemoryAllocateInfo vkiExportMemoryAllocateInfo(VkExternalMemoryHandleTypeFlags handleTypes) {
...
inline VkPhysicalDeviceExternalFenceInfo vkiPhysicalDeviceExternalFenceInfo(VkExternalFenceHandleTypeFlagBits handleType) {
...
inline VkExternalFenceProperties vkiExternalFenceProperties(VkExternalFenceHandleTypeFlags exportFromImportedHandleTypes, VkExternalFenceHandleTypeFlags compatibleHandleTypes, VkExternalFenceFeatureFlags externalFenceFeatures) {
    ...
    ExternalFenceProperties.exportFromImportedHandleTypes = exportFromImportedHandleTypes;
...
inline VkExportFenceCreateInfo vkiExportFenceCreateInfo(VkExternalFenceHandleTypeFlags handleTypes) {
...
inline VkExportSemaphoreCreateInfo vkiExportSemaphoreCreateInfo(VkExternalSemaphoreHandleTypeFlags handleTypes) {
...
inline VkPhysicalDeviceExternalSemaphoreInfo vkiPhysicalDeviceExternalSemaphoreInfo(VkExternalSemaphoreHandleTypeFlagBits handleType) {
...
inline VkExternalSemaphoreProperties vkiExternalSemaphoreProperties(VkExternalSemaphoreHandleTypeFlags exportFromImportedHandleTypes, VkExternalSemaphoreHandleTypeFlags compatibleHandleTypes, VkExternalSemaphoreFeatureFlags externalSemaphoreFeatures) {
    ...
    ExternalSemaphoreProperties.exportFromImportedHandleTypes = exportFromImportedHandleTypes;
    ExternalSemaphoreProperties.compatibleHandleTypes = compatibleHandleTypes;
    ExternalSemaphoreProperties.externalSemaphoreFeatures = externalSemaphoreFeatures;
    return ExternalSemaphoreProperties;
}

inline VkPhysicalDeviceMaintenance3Properties vkiPhysicalDeviceMaintenance3Properties(uint32_t maxPerSetDescriptors, VkDeviceSize maxMemoryAllocationSize) {
    ...
    PhysicalDeviceMaintenance3Properties.maxPerSetDescriptors = maxPerSetDescriptors;
    PhysicalDeviceMaintenance3Properties.maxMemoryAllocationSize = maxMemoryAllocationSize;
    return PhysicalDeviceMaintenance3Properties;
}

inline VkDescriptorSetLayoutSupport vkiDescriptorSetLayoutSupport(VkBool32 supported) {
...
inline VkPhysicalDeviceShaderDrawParametersFeatures vkiPhysicalDeviceShaderDrawParametersFeatures(VkBool32 shaderDrawParameters) {
    ...
    PhysicalDeviceShaderDrawParametersFeatures.shaderDrawParameters = shaderDrawParameters;
    return PhysicalDeviceShaderDrawParametersFeatures;
}

inline VkSurfaceCapabilitiesKHR vkiSurfaceCapabilitiesKHR(uint32_t minImageCount, uint32_t maxImageCount, VkExtent2D currentExtent, VkExtent2D minImageExtent, VkExtent2D maxImageExtent, uint32_t maxImageArrayLayers, VkSurfaceTransformFlagsKHR supportedTransforms, VkSurfaceTransformFlagBitsKHR currentTransform, VkCompositeAlphaFlagsKHR supportedCompositeAlpha, VkImageUsageFlags supportedUsageFlags) {
...
inline VkSurfaceFormatKHR vkiSurfaceFormatKHR(VkFormat format, VkColorSpaceKHR colorSpace) {
...
inline VkPresentInfoKHR vkiPresentInfoKHR(uint32_t waitSemaphoreCount, const VkSemaphore* pWaitSemaphores, uint32_t swapchainCount, const VkSwapchainKHR* pSwapchains, const uint32_t* pImageIndices, VkResult* pResults) {
...
inline VkImageSwapchainCreateInfoKHR vkiImageSwapchainCreateInfoKHR(VkSwapchainKHR swapchain) {
...
inline VkBindImageMemorySwapchainInfoKHR vkiBindImageMemorySwapchainInfoKHR(VkSwapchainKHR swapchain, uint32_t imageIndex) {
...
inline VkAcquireNextImageInfoKHR vkiAcquireNextImageInfoKHR(VkSwapchainKHR swapchain, uint64_t timeout, VkSemaphore semaphore, VkFence fence, uint32_t deviceMask) {
...
// inline VkDeviceGroupPresentCapabilitiesKHR vkiDeviceGroupPresentCapabilitiesKHR(uint32_t presentMask[VK_MAX_DEVICE_GROUP_SIZE], VkDeviceGroupPresentModeFlagsKHR modes) {
...
//     DeviceGroupPresentCapabilitiesKHR.presentMask[VK_MAX_DEVICE_GROUP_SIZE] = presentMask[VK_MAX_DEVICE_GROUP_SIZE];
//     DeviceGroupPresentCapabilitiesKHR.modes = modes;
//     return DeviceGroupPresentCapabilitiesKHR;
// }

inline VkDeviceGroupPresentInfoKHR vkiDeviceGroupPresentInfoKHR(uint32_t swapchainCount, const uint32_t* pDeviceMasks, VkDeviceGroupPresentModeFlagBitsKHR mode) {
...
inline VkDeviceGroupSwapchainCreateInfoKHR vkiDeviceGroupSwapchainCreateInfoKHR(VkDeviceGroupPresentModeFlagsKHR modes) {
...
inline VkDisplayPropertiesKHR vkiDisplayPropertiesKHR(VkDisplayKHR display, const char* displayName, VkExtent2D physicalDimensions, VkExtent2D physicalResolution, VkSurfaceTransformFlagsKHR supportedTransforms, VkBool32 planeReorderPossible, VkBool32 persistentContent) {
...
inline VkDisplayModeParametersKHR vkiDisplayModeParametersKHR(VkExtent2D visibleRegion, uint32_t refreshRate) {
...
inline VkDisplayModePropertiesKHR vkiDisplayModePropertiesKHR(VkDisplayModeKHR displayMode, VkDisplayModeParametersKHR parameters) {
...
inline VkDisplayModeCreateInfoKHR vkiDisplayModeCreateInfoKHR(VkDisplayModeParametersKHR parameters) {
...
inline VkDisplayPlaneCapabilitiesKHR vkiDisplayPlaneCapabilitiesKHR(VkDisplayPlaneAlphaFlagsKHR supportedAlpha, VkOffset2D minSrcPosition, VkOffset2D maxSrcPosition, VkExtent2D minSrcExtent, VkExtent2D maxSrcExtent, VkOffset2D minDstPosition, VkOffset2D maxDstPosition, VkExtent2D minDstExtent, VkExtent2D maxDstExtent) {
...
inline VkDisplayPlanePropertiesKHR vkiDisplayPlanePropertiesKHR(VkDisplayKHR currentDisplay, uint32_t currentStackIndex) {
...
inline VkDisplaySurfaceCreateInfoKHR vkiDisplaySurfaceCreateInfoKHR(VkDisplayModeKHR displayMode, uint32_t planeIndex, uint32_t planeStackIndex, VkSurfaceTransformFlagBitsKHR transform, float globalAlpha, VkDisplayPlaneAlphaFlagBitsKHR alphaMode, VkExtent2D imageExtent) {
...
inline VkDisplayPresentInfoKHR vkiDisplayPresentInfoKHR(VkRect2D srcRect, VkRect2D dstRect, VkBool32 persistent) {
...
inline VkImportMemoryFdInfoKHR vkiImportMemoryFdInfoKHR(VkExternalMemoryHandleTypeFlagBits handleType, int fd) {
...
inline VkMemoryFdPropertiesKHR vkiMemoryFdPropertiesKHR(uint32_t memoryTypeBits) {
...
inline VkMemoryGetFdInfoKHR vkiMemoryGetFdInfoKHR(VkDeviceMemory memory, VkExternalMemoryHandleTypeFlagBits handleType) {
...
inline VkImportSemaphoreFdInfoKHR vkiImportSemaphoreFdInfoKHR(VkSemaphore semaphore, VkExternalSemaphoreHandleTypeFlagBits handleType, int fd) {
...
inline VkSemaphoreGetFdInfoKHR vkiSemaphoreGetFdInfoKHR(VkSemaphore semaphore, VkExternalSemaphoreHandleTypeFlagBits handleType) {
...
inline VkPhysicalDevicePushDescriptorPropertiesKHR vkiPhysicalDevicePushDescriptorPropertiesKHR(uint32_t maxPushDescriptors) {
    ...
    PhysicalDevicePushDescriptorPropertiesKHR.maxPushDescriptors = maxPushDescriptors;
    return PhysicalDevicePushDescriptorPropertiesKHR;
}

inline VkPhysicalDeviceShaderFloat16Int8FeaturesKHR vkiPhysicalDeviceShaderFloat16Int8FeaturesKHR(VkBool32 shaderFloat16, VkBool32 shaderInt8) {
    VkPhysicalDeviceShaderFloat16Int8FeaturesKHR PhysicalDeviceShaderFloat16Int8FeaturesKHR = {};
...
inline VkRectLayerKHR vkiRectLayerKHR(VkOffset2D offset, VkExtent2D extent, uint32_t layer) {
...
inline VkPresentRegionKHR vkiPresentRegionKHR(uint32_t rectangleCount, const VkRectLayerKHR* pRectangles) {
...
inline VkPresentRegionsKHR vkiPresentRegionsKHR(uint32_t swapchainCount, const VkPresentRegionKHR* pRegions) {
...
inline VkPhysicalDeviceImagelessFramebufferFeaturesKHR vkiPhysicalDeviceImagelessFramebufferFeaturesKHR(VkBool32 imagelessFramebuffer) {
    VkPhysicalDeviceImagelessFramebufferFeaturesKHR PhysicalDeviceImagelessFramebufferFeaturesKHR = {};
    ...
    PhysicalDeviceImagelessFramebufferFeaturesKHR.imagelessFramebuffer = imagelessFramebuffer;
    return PhysicalDeviceImagelessFramebufferFeaturesKHR;
}

inline VkFramebufferAttachmentImageInfoKHR vkiFramebufferAttachmentImageInfoKHR(VkImageUsageFlags usage, uint32_t width, uint32_t height, uint32_t layerCount, uint32_t viewFormatCount, const VkFormat* pViewFormats) {
...
inline VkFramebufferAttachmentsCreateInfoKHR vkiFramebufferAttachmentsCreateInfoKHR(uint32_t attachmentImageInfoCount, const VkFramebufferAttachmentImageInfoKHR* pAttachmentImageInfos) {
    ...
    FramebufferAttachmentsCreateInfoKHR.attachmentImageInfoCount = attachmentImageInfoCount;
    FramebufferAttachmentsCreateInfoKHR.pAttachmentImageInfos = pAttachmentImageInfos;
    return FramebufferAttachmentsCreateInfoKHR;
}

inline VkRenderPassAttachmentBeginInfoKHR vkiRenderPassAttachmentBeginInfoKHR(uint32_t attachmentCount, const VkImageView* pAttachments) {
...
inline VkAttachmentDescription2KHR vkiAttachmentDescription2KHR(VkFormat format, VkSampleCountFlagBits samples, VkAttachmentLoadOp loadOp, VkAttachmentStoreOp storeOp, VkAttachmentLoadOp stencilLoadOp, VkAttachmentStoreOp stencilStoreOp, VkImageLayout initialLayout, VkImageLayout finalLayout) {
...
inline VkAttachmentReference2KHR vkiAttachmentReference2KHR(uint32_t attachment, VkImageLayout layout, VkImageAspectFlags aspectMask) {
...
inline VkSubpassDescription2KHR vkiSubpassDescription2KHR(VkPipelineBindPoint pipelineBindPoint, uint32_t viewMask, uint32_t inputAttachmentCount, const VkAttachmentReference2KHR* pInputAttachments, uint32_t colorAttachmentCount, const VkAttachmentReference2KHR* pColorAttachments, const VkAttachmentReference2KHR* pResolveAttachments, const VkAttachmentReference2KHR* pDepthStencilAttachment, uint32_t preserveAttachmentCount, const uint32_t* pPreserveAttachments) {
...
inline VkSubpassDependency2KHR vkiSubpassDependency2KHR(uint32_t srcSubpass, uint32_t dstSubpass, VkPipelineStageFlags srcStageMask, VkPipelineStageFlags dstStageMask, VkAccessFlags srcAccessMask, VkAccessFlags dstAccessMask, VkDependencyFlags dependencyFlags, int32_t viewOffset) {
...
inline VkRenderPassCreateInfo2KHR vkiRenderPassCreateInfo2KHR(uint32_t attachmentCount, const VkAttachmentDescription2KHR* pAttachments, uint32_t subpassCount, const VkSubpassDescription2KHR* pSubpasses, uint32_t dependencyCount, const VkSubpassDependency2KHR* pDependencies, uint32_t correlatedViewMaskCount, const uint32_t* pCorrelatedViewMasks) {
...
inline VkSubpassBeginInfoKHR vkiSubpassBeginInfoKHR(VkSubpassContents contents) {
...
inline VkSharedPresentSurfaceCapabilitiesKHR vkiSharedPresentSurfaceCapabilitiesKHR(VkImageUsageFlags sharedPresentSupportedUsageFlags) {
    ...
    SharedPresentSurfaceCapabilitiesKHR.sharedPresentSupportedUsageFlags = sharedPresentSupportedUsageFlags;
    return SharedPresentSurfaceCapabilitiesKHR;
}

inline VkImportFenceFdInfoKHR vkiImportFenceFdInfoKHR(VkFence fence, VkExternalFenceHandleTypeFlagBits handleType, int fd) {
...
inline VkFenceGetFdInfoKHR vkiFenceGetFdInfoKHR(VkFence fence, VkExternalFenceHandleTypeFlagBits handleType) {
...
inline VkPhysicalDeviceSurfaceInfo2KHR vkiPhysicalDeviceSurfaceInfo2KHR(VkSurfaceKHR surface) {
...
inline VkSurfaceCapabilities2KHR vkiSurfaceCapabilities2KHR(VkSurfaceCapabilitiesKHR surfaceCapabilities) {
...
inline VkSurfaceFormat2KHR vkiSurfaceFormat2KHR(VkSurfaceFormatKHR surfaceFormat) {
...
inline VkDisplayProperties2KHR vkiDisplayProperties2KHR(VkDisplayPropertiesKHR displayProperties) {
...
inline VkDisplayPlaneProperties2KHR vkiDisplayPlaneProperties2KHR(VkDisplayPlanePropertiesKHR displayPlaneProperties) {
...
inline VkDisplayModeProperties2KHR vkiDisplayModeProperties2KHR(VkDisplayModePropertiesKHR displayModeProperties) {
...
inline VkDisplayPlaneInfo2KHR vkiDisplayPlaneInfo2KHR(VkDisplayModeKHR mode, uint32_t planeIndex) {
...
inline VkDisplayPlaneCapabilities2KHR vkiDisplayPlaneCapabilities2KHR(VkDisplayPlaneCapabilitiesKHR capabilities) {
...
inline VkImageFormatListCreateInfoKHR vkiImageFormatListCreateInfoKHR(uint32_t viewFormatCount, const VkFormat* pViewFormats) {
...
inline VkPhysicalDeviceShaderSubgroupExtendedTypesFeaturesKHR vkiPhysicalDeviceShaderSubgroupExtendedTypesFeaturesKHR(VkBool32 shaderSubgroupExtendedTypes) {
    VkPhysicalDeviceShaderSubgroupExtendedTypesFeaturesKHR PhysicalDeviceShaderSubgroupExtendedTypesFeaturesKHR = {};
    PhysicalDeviceShaderSubgroupExtendedTypesFeaturesKHR.sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_SUBGROUP_EXTENDED_TYPES_FEATURES_KHR;
    PhysicalDeviceShaderSubgroupExtendedTypesFeaturesKHR.pNext = nullptr;
    PhysicalDeviceShaderSubgroupExtendedTypesFeaturesKHR.shaderSubgroupExtendedTypes = shaderSubgroupExtendedTypes;
    return PhysicalDeviceShaderSubgroupExtendedTypesFeaturesKHR;
}

inline VkPhysicalDevice8BitStorageFeaturesKHR vkiPhysicalDevice8BitStorageFeaturesKHR(VkBool32 storageBuffer8BitAccess, VkBool32 uniformAndStorageBuffer8BitAccess, VkBool32 storagePushConstant8) {
    ...
    PhysicalDevice8BitStorageFeaturesKHR.storageBuffer8BitAccess = storageBuffer8BitAccess;
    PhysicalDevice8BitStorageFeaturesKHR.uniformAndStorageBuffer8BitAccess = uniformAndStorageBuffer8BitAccess;
    PhysicalDevice8BitStorageFeaturesKHR.storagePushConstant8 = storagePushConstant8;
    return PhysicalDevice8BitStorageFeaturesKHR;
}

inline VkPhysicalDeviceShaderAtomicInt64FeaturesKHR vkiPhysicalDeviceShaderAtomicInt64FeaturesKHR(VkBool32 shaderBufferInt64Atomics, VkBool32 shaderSharedInt64Atomics) {
    VkPhysicalDeviceShaderAtomicInt64FeaturesKHR PhysicalDeviceShaderAtomicInt64FeaturesKHR = {};
    ...
    PhysicalDeviceShaderAtomicInt64FeaturesKHR.shaderBufferInt64Atomics = shaderBufferInt64Atomics;
    PhysicalDeviceShaderAtomicInt64FeaturesKHR.shaderSharedInt64Atomics = shaderSharedInt64Atomics;
    return PhysicalDeviceShaderAtomicInt64FeaturesKHR;
}

inline VkPhysicalDeviceShaderClockFeaturesKHR vkiPhysicalDeviceShaderClockFeaturesKHR(VkBool32 shaderSubgroupClock, VkBool32 shaderDeviceClock) {
    ...
    PhysicalDeviceShaderClockFeaturesKHR.shaderSubgroupClock = shaderSubgroupClock;
    PhysicalDeviceShaderClockFeaturesKHR.shaderDeviceClock = shaderDeviceClock;
    return PhysicalDeviceShaderClockFeaturesKHR;
}

inline VkConformanceVersionKHR vkiConformanceVersionKHR(uint8_t major, uint8_t minor, uint8_t subminor, uint8_t patch) {
...
// inline VkPhysicalDeviceDriverPropertiesKHR vkiPhysicalDeviceDriverPropertiesKHR(VkDriverIdKHR driverID, char driverName[VK_MAX_DRIVER_NAME_SIZE_KHR], char driverInfo[VK_MAX_DRIVER_INFO_SIZE_KHR], VkConformanceVersionKHR conformanceVersion) {
...
inline VkPhysicalDeviceFloatControlsPropertiesKHR vkiPhysicalDeviceFloatControlsPropertiesKHR(VkShaderFloatControlsIndependenceKHR denormBehaviorIndependence, VkShaderFloatControlsIndependenceKHR roundingModeIndependence, VkBool32 shaderSignedZeroInfNanPreserveFloat16, VkBool32 shaderSignedZeroInfNanPreserveFloat32, VkBool32 shaderSignedZeroInfNanPreserveFloat64, VkBool32 shaderDenormPreserveFloat16, VkBool32 shaderDenormPreserveFloat32, VkBool32 shaderDenormPreserveFloat64, VkBool32 shaderDenormFlushToZeroFloat16, VkBool32 shaderDenormFlushToZeroFloat32, VkBool32 shaderDenormFlushToZeroFloat64, VkBool32 shaderRoundingModeRTEFloat16, VkBool32 shaderRoundingModeRTEFloat32, VkBool32 shaderRoundingModeRTEFloat64, VkBool32 shaderRoundingModeRTZFloat16, VkBool32 shaderRoundingModeRTZFloat32, VkBool32 shaderRoundingModeRTZFloat64) {
    ...
    PhysicalDeviceFloatControlsPropertiesKHR.denormBehaviorIndependence = denormBehaviorIndependence;
    PhysicalDeviceFloatControlsPropertiesKHR.roundingModeIndependence = roundingModeIndependence;
    PhysicalDeviceFloatControlsPropertiesKHR.shaderSignedZeroInfNanPreserveFloat16 = shaderSignedZeroInfNanPreserveFloat16;
    PhysicalDeviceFloatControlsPropertiesKHR.shaderSignedZeroInfNanPreserveFloat32 = shaderSignedZeroInfNanPreserveFloat32;
    PhysicalDeviceFloatControlsPropertiesKHR.shaderSignedZeroInfNanPreserveFloat64 = shaderSignedZeroInfNanPreserveFloat64;
    PhysicalDeviceFloatControlsPropertiesKHR.shaderDenormPreserveFloat16 = shaderDenormPreserveFloat16;
    PhysicalDeviceFloatControlsPropertiesKHR.shaderDenormPreserveFloat32 = shaderDenormPreserveFloat32;
    PhysicalDeviceFloatControlsPropertiesKHR.shaderDenormPreserveFloat64 = shaderDenormPreserveFloat64;
    PhysicalDeviceFloatControlsPropertiesKHR.shaderDenormFlushToZeroFloat16 = shaderDenormFlushToZeroFloat16;
    PhysicalDeviceFloatControlsPropertiesKHR.shaderDenormFlushToZeroFloat32 = shaderDenormFlushToZeroFloat32;
    PhysicalDeviceFloatControlsPropertiesKHR.shaderDenormFlushToZeroFloat64 = shaderDenormFlushToZeroFloat64;
    PhysicalDeviceFloatControlsPropertiesKHR.shaderRoundingModeRTEFloat16 = shaderRoundingModeRTEFloat16;
    PhysicalDeviceFloatControlsPropertiesKHR.shaderRoundingModeRTEFloat32 = shaderRoundingModeRTEFloat32;
    PhysicalDeviceFloatControlsPropertiesKHR.shaderRoundingModeRTEFloat64 = shaderRoundingModeRTEFloat64;
    PhysicalDeviceFloatControlsPropertiesKHR.shaderRoundingModeRTZFloat16 = shaderRoundingModeRTZFloat16;
    PhysicalDeviceFloatControlsPropertiesKHR.shaderRoundingModeRTZFloat32 = shaderRoundingModeRTZFloat32;
    PhysicalDeviceFloatControlsPropertiesKHR.shaderRoundingModeRTZFloat64 = shaderRoundingModeRTZFloat64;
    return PhysicalDeviceFloatControlsPropertiesKHR;
}

inline VkSubpassDescriptionDepthStencilResolveKHR vkiSubpassDescriptionDepthStencilResolveKHR(VkResolveModeFlagBitsKHR depthResolveMode, VkResolveModeFlagBitsKHR stencilResolveMode, const VkAttachmentReference2KHR* pDepthStencilResolveAttachment) {
    VkSubpassDescriptionDepthStencilResolveKHR SubpassDescriptionDepthStencilResolveKHR = {};
    ...
    SubpassDescriptionDepthStencilResolveKHR.stencilResolveMode = stencilResolveMode;
    SubpassDescriptionDepthStencilResolveKHR.pDepthStencilResolveAttachment = pDepthStencilResolveAttachment;
    return SubpassDescriptionDepthStencilResolveKHR;
}

inline VkPhysicalDeviceDepthStencilResolvePropertiesKHR vkiPhysicalDeviceDepthStencilResolvePropertiesKHR(VkResolveModeFlagsKHR supportedDepthResolveModes, VkResolveModeFlagsKHR supportedStencilResolveModes, VkBool32 independentResolveNone, VkBool32 independentResolve) {
    VkPhysicalDeviceDepthStencilResolvePropertiesKHR PhysicalDeviceDepthStencilResolvePropertiesKHR = {};
    ...
    PhysicalDeviceDepthStencilResolvePropertiesKHR.supportedDepthResolveModes = supportedDepthResolveModes;
    PhysicalDeviceDepthStencilResolvePropertiesKHR.supportedStencilResolveModes = supportedStencilResolveModes;
    PhysicalDeviceDepthStencilResolvePropertiesKHR.independentResolveNone = independentResolveNone;
    PhysicalDeviceDepthStencilResolvePropertiesKHR.independentResolve = independentResolve;
    return PhysicalDeviceDepthStencilResolvePropertiesKHR;
}

inline VkPhysicalDeviceTimelineSemaphoreFeaturesKHR vkiPhysicalDeviceTimelineSemaphoreFeaturesKHR(VkBool32 timelineSemaphore) {
    VkPhysicalDeviceTimelineSemaphoreFeaturesKHR PhysicalDeviceTimelineSemaphoreFeaturesKHR = {};
    PhysicalDeviceTimelineSemaphoreFeaturesKHR.sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TIMELINE_SEMAPHORE_FEATURES_KHR;
    PhysicalDeviceTimelineSemaphoreFeaturesKHR.pNext = nullptr;
    PhysicalDeviceTimelineSemaphoreFeaturesKHR.timelineSemaphore = timelineSemaphore;
    return PhysicalDeviceTimelineSemaphoreFeaturesKHR;
}

inline VkPhysicalDeviceTimelineSemaphorePropertiesKHR vkiPhysicalDeviceTimelineSemaphorePropertiesKHR(uint64_t maxTimelineSemaphoreValueDifference) {
    VkPhysicalDeviceTimelineSemaphorePropertiesKHR PhysicalDeviceTimelineSemaphorePropertiesKHR = {};
    PhysicalDeviceTimelineSemaphorePropertiesKHR.sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TIMELINE_SEMAPHORE_PROPERTIES_KHR;
    PhysicalDeviceTimelineSemaphorePropertiesKHR.pNext = nullptr;
    PhysicalDeviceTimelineSemaphorePropertiesKHR.maxTimelineSemaphoreValueDifference = maxTimelineSemaphoreValueDifference;
    return PhysicalDeviceTimelineSemaphorePropertiesKHR;
}

inline VkSemaphoreTypeCreateInfoKHR vkiSemaphoreTypeCreateInfoKHR(VkSemaphoreTypeKHR semaphoreType, uint64_t initialValue) {
    VkSemaphoreTypeCreateInfoKHR SemaphoreTypeCreateInfoKHR = {};
    SemaphoreTypeCreateInfoKHR.sType = VK_STRUCTURE_TYPE_SEMAPHORE_TYPE_CREATE_INFO_KHR;
...
inline VkTimelineSemaphoreSubmitInfoKHR vkiTimelineSemaphoreSubmitInfoKHR(uint32_t waitSemaphoreValueCount, const uint64_t* pWaitSemaphoreValues, uint32_t signalSemaphoreValueCount, const uint64_t* pSignalSemaphoreValues) {
    VkTimelineSemaphoreSubmitInfoKHR TimelineSemaphoreSubmitInfoKHR = {};
    TimelineSemaphoreSubmitInfoKHR.sType = VK_STRUCTURE_TYPE_TIMELINE_SEMAPHORE_SUBMIT_INFO_KHR;
    TimelineSemaphoreSubmitInfoKHR.pNext = nullptr;
    TimelineSemaphoreSubmitInfoKHR.waitSemaphoreValueCount = waitSemaphoreValueCount;
    TimelineSemaphoreSubmitInfoKHR.pWaitSemaphoreValues = pWaitSemaphoreValues;
    TimelineSemaphoreSubmitInfoKHR.signalSemaphoreValueCount = signalSemaphoreValueCount;
    TimelineSemaphoreSubmitInfoKHR.pSignalSemaphoreValues = pSignalSemaphoreValues;
    return TimelineSemaphoreSubmitInfoKHR;
}

inline VkSemaphoreWaitInfoKHR vkiSemaphoreWaitInfoKHR(uint32_t semaphoreCount, const VkSemaphore* pSemaphores, const uint64_t* pValues) {
...
inline VkSemaphoreSignalInfoKHR vkiSemaphoreSignalInfoKHR(VkSemaphore semaphore, uint64_t value) {
...
inline VkPhysicalDeviceVulkanMemoryModelFeaturesKHR vkiPhysicalDeviceVulkanMemoryModelFeaturesKHR(VkBool32 vulkanMemoryModel, VkBool32 vulkanMemoryModelDeviceScope, VkBool32 vulkanMemoryModelAvailabilityVisibilityChains) {
    VkPhysicalDeviceVulkanMemoryModelFeaturesKHR PhysicalDeviceVulkanMemoryModelFeaturesKHR = {};
    ...
    PhysicalDeviceVulkanMemoryModelFeaturesKHR.vulkanMemoryModel = vulkanMemoryModel;
    PhysicalDeviceVulkanMemoryModelFeaturesKHR.vulkanMemoryModelDeviceScope = vulkanMemoryModelDeviceScope;
    PhysicalDeviceVulkanMemoryModelFeaturesKHR.vulkanMemoryModelAvailabilityVisibilityChains = vulkanMemoryModelAvailabilityVisibilityChains;
    return PhysicalDeviceVulkanMemoryModelFeaturesKHR;
}

inline VkSurfaceProtectedCapabilitiesKHR vkiSurfaceProtectedCapabilitiesKHR(VkBool32 supportsProtected) {
...
inline VkPhysicalDeviceUniformBufferStandardLayoutFeaturesKHR vkiPhysicalDeviceUniformBufferStandardLayoutFeaturesKHR(VkBool32 uniformBufferStandardLayout) {
    VkPhysicalDeviceUniformBufferStandardLayoutFeaturesKHR PhysicalDeviceUniformBufferStandardLayoutFeaturesKHR = {};
    ...
    PhysicalDeviceUniformBufferStandardLayoutFeaturesKHR.uniformBufferStandardLayout = uniformBufferStandardLayout;
    return PhysicalDeviceUniformBufferStandardLayoutFeaturesKHR;
}

inline VkPhysicalDevicePipelineExecutablePropertiesFeaturesKHR vkiPhysicalDevicePipelineExecutablePropertiesFeaturesKHR(VkBool32 pipelineExecutableInfo) {
    ...
    PhysicalDevicePipelineExecutablePropertiesFeaturesKHR.pipelineExecutableInfo = pipelineExecutableInfo;
...
// inline VkPipelineExecutablePropertiesKHR vkiPipelineExecutablePropertiesKHR(VkShaderStageFlags stages, char name[VK_MAX_DESCRIPTION_SIZE], char description[VK_MAX_DESCRIPTION_SIZE], uint32_t subgroupSize) {
...
//     PipelineExecutablePropertiesKHR.name[VK_MAX_DESCRIPTION_SIZE] = name[VK_MAX_DESCRIPTION_SIZE];
//     PipelineExecutablePropertiesKHR.description[VK_MAX_DESCRIPTION_SIZE] = description[VK_MAX_DESCRIPTION_SIZE];
//     PipelineExecutablePropertiesKHR.subgroupSize = subgroupSize;
//     return PipelineExecutablePropertiesKHR;
// }

inline VkPipelineExecutableInfoKHR vkiPipelineExecutableInfoKHR(VkPipeline pipeline, uint32_t executableIndex) {
...
// inline VkPipelineExecutableStatisticKHR vkiPipelineExecutableStatisticKHR(char name[VK_MAX_DESCRIPTION_SIZE], char description[VK_MAX_DESCRIPTION_SIZE], VkPipelineExecutableStatisticFormatKHR format, VkPipelineExecutableStatisticValueKHR value) {
...
//     PipelineExecutableStatisticKHR.name[VK_MAX_DESCRIPTION_SIZE] = name[VK_MAX_DESCRIPTION_SIZE];
//     PipelineExecutableStatisticKHR.description[VK_MAX_DESCRIPTION_SIZE] = description[VK_MAX_DESCRIPTION_SIZE];
...
// inline VkPipelineExecutableInternalRepresentationKHR vkiPipelineExecutableInternalRepresentationKHR(char name[VK_MAX_DESCRIPTION_SIZE], char description[VK_MAX_DESCRIPTION_SIZE], VkBool32 isText, size_t dataSize, void* pData) {
//     VkPipelineExecutableInternalRepresentationKHR PipelineExecutableInternalRepresentationKHR = {};
...
//     PipelineExecutableInternalRepresentationKHR.name[VK_MAX_DESCRIPTION_SIZE] = name[VK_MAX_DESCRIPTION_SIZE];
//     PipelineExecutableInternalRepresentationKHR.description[VK_MAX_DESCRIPTION_SIZE] = description[VK_MAX_DESCRIPTION_SIZE];
...
inline VkDebugReportCallbackCreateInfoEXT vkiDebugReportCallbackCreateInfoEXT(PFN_vkDebugReportCallbackEXT pfnCallback, void* pUserData) {
...
inline VkPipelineRasterizationStateRasterizationOrderAMD vkiPipelineRasterizationStateRasterizationOrderAMD(VkRasterizationOrderAMD rasterizationOrder) {
    ...
    PipelineRasterizationStateRasterizationOrderAMD.rasterizationOrder = rasterizationOrder;
    return PipelineRasterizationStateRasterizationOrderAMD;
}

inline VkDebugMarkerObjectNameInfoEXT vkiDebugMarkerObjectNameInfoEXT(VkDebugReportObjectTypeEXT objectType, uint64_t object, const char* pObjectName) {
...
inline VkDebugMarkerObjectTagInfoEXT vkiDebugMarkerObjectTagInfoEXT(VkDebugReportObjectTypeEXT objectType, uint64_t object, uint64_t tagName, size_t tagSize, const void* pTag) {
...
// inline VkDebugMarkerMarkerInfoEXT vkiDebugMarkerMarkerInfoEXT(const char* pMarkerName, float color[4]) {
...
inline VkDedicatedAllocationImageCreateInfoNV vkiDedicatedAllocationImageCreateInfoNV(VkBool32 dedicatedAllocation) {
    ...
    DedicatedAllocationImageCreateInfoNV.dedicatedAllocation = dedicatedAllocation;
    return DedicatedAllocationImageCreateInfoNV;
}

inline VkDedicatedAllocationBufferCreateInfoNV vkiDedicatedAllocationBufferCreateInfoNV(VkBool32 dedicatedAllocation) {
    ...
    DedicatedAllocationBufferCreateInfoNV.dedicatedAllocation = dedicatedAllocation;
    return DedicatedAllocationBufferCreateInfoNV;
}

inline VkDedicatedAllocationMemoryAllocateInfoNV vkiDedicatedAllocationMemoryAllocateInfoNV(VkImage image, VkBuffer buffer) {
...
inline VkPhysicalDeviceTransformFeedbackFeaturesEXT vkiPhysicalDeviceTransformFeedbackFeaturesEXT(VkBool32 transformFeedback, VkBool32 geometryStreams) {
    ...
    PhysicalDeviceTransformFeedbackFeaturesEXT.transformFeedback = transformFeedback;
...
inline VkPhysicalDeviceTransformFeedbackPropertiesEXT vkiPhysicalDeviceTransformFeedbackPropertiesEXT(uint32_t maxTransformFeedbackStreams, uint32_t maxTransformFeedbackBuffers, VkDeviceSize maxTransformFeedbackBufferSize, uint32_t maxTransformFeedbackStreamDataSize, uint32_t maxTransformFeedbackBufferDataSize, uint32_t maxTransformFeedbackBufferDataStride, VkBool32 transformFeedbackQueries, VkBool32 transformFeedbackStreamsLinesTriangles, VkBool32 transformFeedbackRasterizationStreamSelect, VkBool32 transformFeedbackDraw) {
    ...
    PhysicalDeviceTransformFeedbackPropertiesEXT.maxTransformFeedbackStreams = maxTransformFeedbackStreams;
    PhysicalDeviceTransformFeedbackPropertiesEXT.maxTransformFeedbackBuffers = maxTransformFeedbackBuffers;
    PhysicalDeviceTransformFeedbackPropertiesEXT.maxTransformFeedbackBufferSize = maxTransformFeedbackBufferSize;
    PhysicalDeviceTransformFeedbackPropertiesEXT.maxTransformFeedbackStreamDataSize = maxTransformFeedbackStreamDataSize;
    PhysicalDeviceTransformFeedbackPropertiesEXT.maxTransformFeedbackBufferDataSize = maxTransformFeedbackBufferDataSize;
    PhysicalDeviceTransformFeedbackPropertiesEXT.maxTransformFeedbackBufferDataStride = maxTransformFeedbackBufferDataStride;
    PhysicalDeviceTransformFeedbackPropertiesEXT.transformFeedbackQueries = transformFeedbackQueries;
    PhysicalDeviceTransformFeedbackPropertiesEXT.transformFeedbackStreamsLinesTriangles = transformFeedbackStreamsLinesTriangles;
    PhysicalDeviceTransformFeedbackPropertiesEXT.transformFeedbackRasterizationStreamSelect = transformFeedbackRasterizationStreamSelect;
    PhysicalDeviceTransformFeedbackPropertiesEXT.transformFeedbackDraw = transformFeedbackDraw;
    return PhysicalDeviceTransformFeedbackPropertiesEXT;
}

inline VkPipelineRasterizationStateStreamCreateInfoEXT vkiPipelineRasterizationStateStreamCreateInfoEXT(uint32_t rasterizationStream) {
    ...
    PipelineRasterizationStateStreamCreateInfoEXT.rasterizationStream = rasterizationStream;
    return PipelineRasterizationStateStreamCreateInfoEXT;
}

inline VkImageViewHandleInfoNVX vkiImageViewHandleInfoNVX(VkImageView imageView, VkDescriptorType descriptorType, VkSampler sampler) {
...
inline VkTextureLODGatherFormatPropertiesAMD vkiTextureLODGatherFormatPropertiesAMD(VkBool32 supportsTextureGatherLODBiasAMD) {
    ...
    TextureLODGatherFormatPropertiesAMD.supportsTextureGatherLODBiasAMD = supportsTextureGatherLODBiasAMD;
    return TextureLODGatherFormatPropertiesAMD;
}

inline VkShaderResourceUsageAMD vkiShaderResourceUsageAMD(uint32_t numUsedVgprs, uint32_t numUsedSgprs, uint32_t ldsSizePerLocalWorkGroup, size_t ldsUsageSizeInBytes, size_t scratchMemUsageInBytes) {
...
// inline VkShaderStatisticsInfoAMD vkiShaderStatisticsInfoAMD(VkShaderStageFlags shaderStageMask, VkShaderResourceUsageAMD resourceUsage, uint32_t numPhysicalVgprs, uint32_t numPhysicalSgprs, uint32_t numAvailableVgprs, uint32_t numAvailableSgprs, uint32_t computeWorkGroupSize[3]) {
...
//     ShaderStatisticsInfoAMD.computeWorkGroupSize[3] = computeWorkGroupSize[3];
//     return ShaderStatisticsInfoAMD;
// }

inline VkPhysicalDeviceCornerSampledImageFeaturesNV vkiPhysicalDeviceCornerSampledImageFeaturesNV(VkBool32 cornerSampledImage) {
    ...
    PhysicalDeviceCornerSampledImageFeaturesNV.cornerSampledImage = cornerSampledImage;
    return PhysicalDeviceCornerSampledImageFeaturesNV;
}

inline VkExternalImageFormatPropertiesNV vkiExternalImageFormatPropertiesNV(VkImageFormatProperties imageFormatProperties, VkExternalMemoryFeatureFlagsNV externalMemoryFeatures, VkExternalMemoryHandleTypeFlagsNV exportFromImportedHandleTypes, VkExternalMemoryHandleTypeFlagsNV compatibleHandleTypes) {
    ...
    ExternalImageFormatPropertiesNV.externalMemoryFeatures = externalMemoryFeatures;
    ExternalImageFormatPropertiesNV.exportFromImportedHandleTypes = exportFromImportedHandleTypes;
    ExternalImageFormatPropertiesNV.compatibleHandleTypes = compatibleHandleTypes;
    return ExternalImageFormatPropertiesNV;
}

inline VkExternalMemoryImageCreateInfoNV vkiExternalMemoryImageCreateInfoNV(VkExternalMemoryHandleTypeFlagsNV handleTypes) {
...
inline VkExportMemoryAllocateInfoNV vkiExportMemoryAllocateInfoNV(VkExternalMemoryHandleTypeFlagsNV handleTypes) {
...
inline VkValidationFlagsEXT vkiValidationFlagsEXT(uint32_t disabledValidationCheckCount, const VkValidationCheckEXT* pDisabledValidationChecks) {
    ...
    ValidationFlagsEXT.disabledValidationCheckCount = disabledValidationCheckCount;
    ValidationFlagsEXT.pDisabledValidationChecks = pDisabledValidationChecks;
    return ValidationFlagsEXT;
}

inline VkPhysicalDeviceTextureCompressionASTCHDRFeaturesEXT vkiPhysicalDeviceTextureCompressionASTCHDRFeaturesEXT(VkBool32 textureCompressionASTC_HDR) {
    VkPhysicalDeviceTextureCompressionASTCHDRFeaturesEXT PhysicalDeviceTextureCompressionASTCHDRFeaturesEXT = {};
    ...
    PhysicalDeviceTextureCompressionASTCHDRFeaturesEXT.textureCompressionASTC_HDR = textureCompressionASTC_HDR;
    return PhysicalDeviceTextureCompressionASTCHDRFeaturesEXT;
}

inline VkImageViewASTCDecodeModeEXT vkiImageViewASTCDecodeModeEXT(VkFormat decodeMode) {
...
inline VkPhysicalDeviceASTCDecodeFeaturesEXT vkiPhysicalDeviceASTCDecodeFeaturesEXT(VkBool32 decodeModeSharedExponent) {
    ...
    PhysicalDeviceASTCDecodeFeaturesEXT.decodeModeSharedExponent = decodeModeSharedExponent;
    return PhysicalDeviceASTCDecodeFeaturesEXT;
}

inline VkConditionalRenderingBeginInfoEXT vkiConditionalRenderingBeginInfoEXT(VkBuffer buffer, VkDeviceSize offset) {
...
inline VkPhysicalDeviceConditionalRenderingFeaturesEXT vkiPhysicalDeviceConditionalRenderingFeaturesEXT(VkBool32 conditionalRendering, VkBool32 inheritedConditionalRendering) {
    ...
    PhysicalDeviceConditionalRenderingFeaturesEXT.conditionalRendering = conditionalRendering;
    PhysicalDeviceConditionalRenderingFeaturesEXT.inheritedConditionalRendering = inheritedConditionalRendering;
    return PhysicalDeviceConditionalRenderingFeaturesEXT;
}

inline VkCommandBufferInheritanceConditionalRenderingInfoEXT vkiCommandBufferInheritanceConditionalRenderingInfoEXT(VkBool32 conditionalRenderingEnable) {
    VkCommandBufferInheritanceConditionalRenderingInfoEXT CommandBufferInheritanceConditionalRenderingInfoEXT = {};
    ...
    CommandBufferInheritanceConditionalRenderingInfoEXT.conditionalRenderingEnable = conditionalRenderingEnable;
    return CommandBufferInheritanceConditionalRenderingInfoEXT;
}

inline VkDeviceGeneratedCommandsFeaturesNVX vkiDeviceGeneratedCommandsFeaturesNVX(VkBool32 computeBindingPointSupport) {
    ...
    DeviceGeneratedCommandsFeaturesNVX.pNext = nullptr;
    DeviceGeneratedCommandsFeaturesNVX.computeBindingPointSupport = computeBindingPointSupport;
    return DeviceGeneratedCommandsFeaturesNVX;
}

inline VkDeviceGeneratedCommandsLimitsNVX vkiDeviceGeneratedCommandsLimitsNVX(uint32_t maxIndirectCommandsLayoutTokenCount, uint32_t maxObjectEntryCounts, uint32_t minSequenceCountBufferOffsetAlignment, uint32_t minSequenceIndexBufferOffsetAlignment, uint32_t minCommandsTokenBufferOffsetAlignment) {
    ...
    DeviceGeneratedCommandsLimitsNVX.pNext = nullptr;
    DeviceGeneratedCommandsLimitsNVX.maxIndirectCommandsLayoutTokenCount = maxIndirectCommandsLayoutTokenCount;
    DeviceGeneratedCommandsLimitsNVX.maxObjectEntryCounts = maxObjectEntryCounts;
    DeviceGeneratedCommandsLimitsNVX.minSequenceCountBufferOffsetAlignment = minSequenceCountBufferOffsetAlignment;
    DeviceGeneratedCommandsLimitsNVX.minSequenceIndexBufferOffsetAlignment = minSequenceIndexBufferOffsetAlignment;
    DeviceGeneratedCommandsLimitsNVX.minCommandsTokenBufferOffsetAlignment = minCommandsTokenBufferOffsetAlignment;
    return DeviceGeneratedCommandsLimitsNVX;
}

inline VkIndirectCommandsTokenNVX vkiIndirectCommandsTokenNVX(VkIndirectCommandsTokenTypeNVX tokenType, VkBuffer buffer, VkDeviceSize offset) {
    VkIndirectCommandsTokenNVX IndirectCommandsTokenNVX = {};
    IndirectCommandsTokenNVX.tokenType = tokenType;
    IndirectCommandsTokenNVX.buffer = buffer;
    IndirectCommandsTokenNVX.offset = offset;
    return IndirectCommandsTokenNVX;
}

inline VkIndirectCommandsLayoutTokenNVX vkiIndirectCommandsLayoutTokenNVX(VkIndirectCommandsTokenTypeNVX tokenType, uint32_t bindingUnit, uint32_t dynamicCount, uint32_t divisor) {
    VkIndirectCommandsLayoutTokenNVX IndirectCommandsLayoutTokenNVX = {};
    IndirectCommandsLayoutTokenNVX.tokenType = tokenType;
    IndirectCommandsLayoutTokenNVX.bindingUnit = bindingUnit;
    IndirectCommandsLayoutTokenNVX.dynamicCount = dynamicCount;
    IndirectCommandsLayoutTokenNVX.divisor = divisor;
    return IndirectCommandsLayoutTokenNVX;
}

inline VkIndirectCommandsLayoutCreateInfoNVX vkiIndirectCommandsLayoutCreateInfoNVX(VkPipelineBindPoint pipelineBindPoint, uint32_t tokenCount, const VkIndirectCommandsLayoutTokenNVX* pTokens) {
    VkIndirectCommandsLayoutCreateInfoNVX IndirectCommandsLayoutCreateInfoNVX = {};
    IndirectCommandsLayoutCreateInfoNVX.sType = VK_STRUCTURE_TYPE_INDIRECT_COMMANDS_LAYOUT_CREATE_INFO_NVX;
    IndirectCommandsLayoutCreateInfoNVX.pNext = nullptr;
    IndirectCommandsLayoutCreateInfoNVX.flags = 0;
    IndirectCommandsLayoutCreateInfoNVX.pipelineBindPoint = pipelineBindPoint;
    IndirectCommandsLayoutCreateInfoNVX.tokenCount = tokenCount;
    IndirectCommandsLayoutCreateInfoNVX.pTokens = pTokens;
    return IndirectCommandsLayoutCreateInfoNVX;
}

inline VkCmdProcessCommandsInfoNVX vkiCmdProcessCommandsInfoNVX(VkObjectTableNVX objectTable, VkIndirectCommandsLayoutNVX indirectCommandsLayout, uint32_t indirectCommandsTokenCount, const VkIndirectCommandsTokenNVX* pIndirectCommandsTokens, uint32_t maxSequencesCount, VkCommandBuffer targetCommandBuffer, VkBuffer sequencesCountBuffer, VkDeviceSize sequencesCountOffset, VkBuffer sequencesIndexBuffer, VkDeviceSize sequencesIndexOffset) {
    VkCmdProcessCommandsInfoNVX CmdProcessCommandsInfoNVX = {};
    CmdProcessCommandsInfoNVX.sType = VK_STRUCTURE_TYPE_CMD_PROCESS_COMMANDS_INFO_NVX;
    CmdProcessCommandsInfoNVX.pNext = nullptr;
    CmdProcessCommandsInfoNVX.objectTable = objectTable;
    CmdProcessCommandsInfoNVX.indirectCommandsLayout = indirectCommandsLayout;
    CmdProcessCommandsInfoNVX.indirectCommandsTokenCount = indirectCommandsTokenCount;
    CmdProcessCommandsInfoNVX.pIndirectCommandsTokens = pIndirectCommandsTokens;
    CmdProcessCommandsInfoNVX.maxSequencesCount = maxSequencesCount;
    CmdProcessCommandsInfoNVX.targetCommandBuffer = targetCommandBuffer;
    CmdProcessCommandsInfoNVX.sequencesCountBuffer = sequencesCountBuffer;
    CmdProcessCommandsInfoNVX.sequencesCountOffset = sequencesCountOffset;
    CmdProcessCommandsInfoNVX.sequencesIndexBuffer = sequencesIndexBuffer;
    CmdProcessCommandsInfoNVX.sequencesIndexOffset = sequencesIndexOffset;
    return CmdProcessCommandsInfoNVX;
}

inline VkCmdReserveSpaceForCommandsInfoNVX vkiCmdReserveSpaceForCommandsInfoNVX(VkObjectTableNVX objectTable, VkIndirectCommandsLayoutNVX indirectCommandsLayout, uint32_t maxSequencesCount) {
    ...
    CmdReserveSpaceForCommandsInfoNVX.pNext = nullptr;
    CmdReserveSpaceForCommandsInfoNVX.objectTable = objectTable;
    CmdReserveSpaceForCommandsInfoNVX.indirectCommandsLayout = indirectCommandsLayout;
    CmdReserveSpaceForCommandsInfoNVX.maxSequencesCount = maxSequencesCount;
    return CmdReserveSpaceForCommandsInfoNVX;
}

inline VkObjectTableCreateInfoNVX vkiObjectTableCreateInfoNVX(uint32_t objectCount, const VkObjectEntryTypeNVX* pObjectEntryTypes, const uint32_t* pObjectEntryCounts, const VkObjectEntryUsageFlagsNVX* pObjectEntryUsageFlags, uint32_t maxUniformBuffersPerDescriptor, uint32_t maxStorageBuffersPerDescriptor, uint32_t maxStorageImagesPerDescriptor, uint32_t maxSampledImagesPerDescriptor, uint32_t maxPipelineLayouts) {
    VkObjectTableCreateInfoNVX ObjectTableCreateInfoNVX = {};
    ObjectTableCreateInfoNVX.sType = VK_STRUCTURE_TYPE_OBJECT_TABLE_CREATE_INFO_NVX;
    ObjectTableCreateInfoNVX.pNext = nullptr;
    ObjectTableCreateInfoNVX.objectCount = objectCount;
    ObjectTableCreateInfoNVX.pObjectEntryTypes = pObjectEntryTypes;
    ObjectTableCreateInfoNVX.pObjectEntryCounts = pObjectEntryCounts;
    ObjectTableCreateInfoNVX.pObjectEntryUsageFlags = pObjectEntryUsageFlags;
    ObjectTableCreateInfoNVX.maxUniformBuffersPerDescriptor = maxUniformBuffersPerDescriptor;
    ObjectTableCreateInfoNVX.maxStorageBuffersPerDescriptor = maxStorageBuffersPerDescriptor;
    ObjectTableCreateInfoNVX.maxStorageImagesPerDescriptor = maxStorageImagesPerDescriptor;
    ObjectTableCreateInfoNVX.maxSampledImagesPerDescriptor = maxSampledImagesPerDescriptor;
    ObjectTableCreateInfoNVX.maxPipelineLayouts = maxPipelineLayouts;
    return ObjectTableCreateInfoNVX;
}

inline VkObjectTableEntryNVX vkiObjectTableEntryNVX(VkObjectEntryTypeNVX type) {
    VkObjectTableEntryNVX ObjectTableEntryNVX = {};
    ObjectTableEntryNVX.flags = 0;
    ObjectTableEntryNVX.type = type;
    return ObjectTableEntryNVX;
}

inline VkObjectTablePipelineEntryNVX vkiObjectTablePipelineEntryNVX(VkObjectEntryTypeNVX type, VkPipeline pipeline) {
    VkObjectTablePipelineEntryNVX ObjectTablePipelineEntryNVX = {};
    ObjectTablePipelineEntryNVX.flags = 0;
    ObjectTablePipelineEntryNVX.type = type;
    ObjectTablePipelineEntryNVX.pipeline = pipeline;
    return ObjectTablePipelineEntryNVX;
}

inline VkObjectTableDescriptorSetEntryNVX vkiObjectTableDescriptorSetEntryNVX(VkObjectEntryTypeNVX type, VkPipelineLayout pipelineLayout, VkDescriptorSet descriptorSet) {
    VkObjectTableDescriptorSetEntryNVX ObjectTableDescriptorSetEntryNVX = {};
    ObjectTableDescriptorSetEntryNVX.flags = 0;
    ObjectTableDescriptorSetEntryNVX.type = type;
    ObjectTableDescriptorSetEntryNVX.pipelineLayout = pipelineLayout;
    ObjectTableDescriptorSetEntryNVX.descriptorSet = descriptorSet;
    return ObjectTableDescriptorSetEntryNVX;
}

inline VkObjectTableVertexBufferEntryNVX vkiObjectTableVertexBufferEntryNVX(VkObjectEntryTypeNVX type, VkBuffer buffer) {
    VkObjectTableVertexBufferEntryNVX ObjectTableVertexBufferEntryNVX = {};
    ObjectTableVertexBufferEntryNVX.flags = 0;
    ObjectTableVertexBufferEntryNVX.type = type;
    ObjectTableVertexBufferEntryNVX.buffer = buffer;
    return ObjectTableVertexBufferEntryNVX;
}

inline VkObjectTableIndexBufferEntryNVX vkiObjectTableIndexBufferEntryNVX(VkObjectEntryTypeNVX type, VkBuffer buffer, VkIndexType indexType) {
    VkObjectTableIndexBufferEntryNVX ObjectTableIndexBufferEntryNVX = {};
    ObjectTableIndexBufferEntryNVX.flags = 0;
    ObjectTableIndexBufferEntryNVX.type = type;
    ObjectTableIndexBufferEntryNVX.buffer = buffer;
    ObjectTableIndexBufferEntryNVX.indexType = indexType;
    return ObjectTableIndexBufferEntryNVX;
}

inline VkObjectTablePushConstantEntryNVX vkiObjectTablePushConstantEntryNVX(VkObjectEntryTypeNVX type, VkPipelineLayout pipelineLayout, VkShaderStageFlags stageFlags) {
    VkObjectTablePushConstantEntryNVX ObjectTablePushConstantEntryNVX = {};
    ObjectTablePushConstantEntryNVX.flags = 0;
    ObjectTablePushConstantEntryNVX.type = type;
    ObjectTablePushConstantEntryNVX.pipelineLayout = pipelineLayout;
    ObjectTablePushConstantEntryNVX.stageFlags = stageFlags;
    return ObjectTablePushConstantEntryNVX;
}

inline VkViewportWScalingNV vkiViewportWScalingNV(float xcoeff, float ycoeff) {
    VkViewportWScalingNV ViewportWScalingNV = {};
    ViewportWScalingNV.xcoeff = xcoeff;
    ViewportWScalingNV.ycoeff = ycoeff;
    return ViewportWScalingNV;
}

inline VkPipelineViewportWScalingStateCreateInfoNV vkiPipelineViewportWScalingStateCreateInfoNV(VkBool32 viewportWScalingEnable, uint32_t viewportCount, const VkViewportWScalingNV* pViewportWScalings) {
    ...
    PipelineViewportWScalingStateCreateInfoNV.viewportWScalingEnable = viewportWScalingEnable;
    PipelineViewportWScalingStateCreateInfoNV.viewportCount = viewportCount;
    PipelineViewportWScalingStateCreateInfoNV.pViewportWScalings = pViewportWScalings;
    return PipelineViewportWScalingStateCreateInfoNV;
}

inline VkSurfaceCapabilities2EXT vkiSurfaceCapabilities2EXT(uint32_t minImageCount, uint32_t maxImageCount, VkExtent2D currentExtent, VkExtent2D minImageExtent, VkExtent2D maxImageExtent, uint32_t maxImageArrayLayers, VkSurfaceTransformFlagsKHR supportedTransforms, VkSurfaceTransformFlagBitsKHR currentTransform, VkCompositeAlphaFlagsKHR supportedCompositeAlpha, VkImageUsageFlags supportedUsageFlags, VkSurfaceCounterFlagsEXT supportedSurfaceCounters) {
...
inline VkDisplayPowerInfoEXT vkiDisplayPowerInfoEXT(VkDisplayPowerStateEXT powerState) {
...
inline VkDeviceEventInfoEXT vkiDeviceEventInfoEXT(VkDeviceEventTypeEXT deviceEvent) {
...
inline VkDisplayEventInfoEXT vkiDisplayEventInfoEXT(VkDisplayEventTypeEXT displayEvent) {
...
inline VkSwapchainCounterCreateInfoEXT vkiSwapchainCounterCreateInfoEXT(VkSurfaceCounterFlagsEXT surfaceCounters) {
...
inline VkRefreshCycleDurationGOOGLE vkiRefreshCycleDurationGOOGLE(uint64_t refreshDuration) {
...
inline VkPastPresentationTimingGOOGLE vkiPastPresentationTimingGOOGLE(uint32_t presentID, uint64_t desiredPresentTime, uint64_t actualPresentTime, uint64_t earliestPresentTime, uint64_t presentMargin) {
...
inline VkPresentTimeGOOGLE vkiPresentTimeGOOGLE(uint32_t presentID, uint64_t desiredPresentTime) {
...
inline VkPresentTimesInfoGOOGLE vkiPresentTimesInfoGOOGLE(uint32_t swapchainCount, const VkPresentTimeGOOGLE* pTimes) {
...
inline VkPhysicalDeviceMultiviewPerViewAttributesPropertiesNVX vkiPhysicalDeviceMultiviewPerViewAttributesPropertiesNVX(VkBool32 perViewPositionAllComponents) {
    ...
    PhysicalDeviceMultiviewPerViewAttributesPropertiesNVX.perViewPositionAllComponents = perViewPositionAllComponents;
    return PhysicalDeviceMultiviewPerViewAttributesPropertiesNVX;
}

inline VkViewportSwizzleNV vkiViewportSwizzleNV(VkViewportCoordinateSwizzleNV x, VkViewportCoordinateSwizzleNV y, VkViewportCoordinateSwizzleNV z, VkViewportCoordinateSwizzleNV w) {
...
inline VkPipelineViewportSwizzleStateCreateInfoNV vkiPipelineViewportSwizzleStateCreateInfoNV(uint32_t viewportCount, const VkViewportSwizzleNV* pViewportSwizzles) {
    ...
    PipelineViewportSwizzleStateCreateInfoNV.pViewportSwizzles = pViewportSwizzles;
    return PipelineViewportSwizzleStateCreateInfoNV;
}

inline VkPhysicalDeviceDiscardRectanglePropertiesEXT vkiPhysicalDeviceDiscardRectanglePropertiesEXT(uint32_t maxDiscardRectangles) {
    ...
    PhysicalDeviceDiscardRectanglePropertiesEXT.maxDiscardRectangles = maxDiscardRectangles;
    return PhysicalDeviceDiscardRectanglePropertiesEXT;
}

inline VkPipelineDiscardRectangleStateCreateInfoEXT vkiPipelineDiscardRectangleStateCreateInfoEXT(VkDiscardRectangleModeEXT discardRectangleMode, uint32_t discardRectangleCount, const VkRect2D* pDiscardRectangles) {
    ...
    PipelineDiscardRectangleStateCreateInfoEXT.discardRectangleMode = discardRectangleMode;
    PipelineDiscardRectangleStateCreateInfoEXT.discardRectangleCount = discardRectangleCount;
    PipelineDiscardRectangleStateCreateInfoEXT.pDiscardRectangles = pDiscardRectangles;
    return PipelineDiscardRectangleStateCreateInfoEXT;
}

inline VkPhysicalDeviceConservativeRasterizationPropertiesEXT vkiPhysicalDeviceConservativeRasterizationPropertiesEXT(float primitiveOverestimationSize, float maxExtraPrimitiveOverestimationSize, float extraPrimitiveOverestimationSizeGranularity, VkBool32 primitiveUnderestimation, VkBool32 conservativePointAndLineRasterization, VkBool32 degenerateTrianglesRasterized, VkBool32 degenerateLinesRasterized, VkBool32 fullyCoveredFragmentShaderInputVariable, VkBool32 conservativeRasterizationPostDepthCoverage) {
    ...
    PhysicalDeviceConservativeRasterizationPropertiesEXT.primitiveOverestimationSize = primitiveOverestimationSize;
    PhysicalDeviceConservativeRasterizationPropertiesEXT.maxExtraPrimitiveOverestimationSize = maxExtraPrimitiveOverestimationSize;
    PhysicalDeviceConservativeRasterizationPropertiesEXT.extraPrimitiveOverestimationSizeGranularity = extraPrimitiveOverestimationSizeGranularity;
    PhysicalDeviceConservativeRasterizationPropertiesEXT.primitiveUnderestimation = primitiveUnderestimation;
    PhysicalDeviceConservativeRasterizationPropertiesEXT.conservativePointAndLineRasterization = conservativePointAndLineRasterization;
    PhysicalDeviceConservativeRasterizationPropertiesEXT.degenerateTrianglesRasterized = degenerateTrianglesRasterized;
    PhysicalDeviceConservativeRasterizationPropertiesEXT.degenerateLinesRasterized = degenerateLinesRasterized;
    PhysicalDeviceConservativeRasterizationPropertiesEXT.fullyCoveredFragmentShaderInputVariable = fullyCoveredFragmentShaderInputVariable;
    PhysicalDeviceConservativeRasterizationPropertiesEXT.conservativeRasterizationPostDepthCoverage = conservativeRasterizationPostDepthCoverage;
    return PhysicalDeviceConservativeRasterizationPropertiesEXT;
}

inline VkPipelineRasterizationConservativeStateCreateInfoEXT vkiPipelineRasterizationConservativeStateCreateInfoEXT(VkConservativeRasterizationModeEXT conservativeRasterizationMode, float extraPrimitiveOverestimationSize) {
    ...
    PipelineRasterizationConservativeStateCreateInfoEXT.conservativeRasterizationMode = conservativeRasterizationMode;
    PipelineRasterizationConservativeStateCreateInfoEXT.extraPrimitiveOverestimationSize = extraPrimitiveOverestimationSize;
    return PipelineRasterizationConservativeStateCreateInfoEXT;
}

inline VkPhysicalDeviceDepthClipEnableFeaturesEXT vkiPhysicalDeviceDepthClipEnableFeaturesEXT(VkBool32 depthClipEnable) {
...
inline VkPipelineRasterizationDepthClipStateCreateInfoEXT vkiPipelineRasterizationDepthClipStateCreateInfoEXT(VkBool32 depthClipEnable) {
    ...
    PipelineRasterizationDepthClipStateCreateInfoEXT.depthClipEnable = depthClipEnable;
...
inline VkHdrMetadataEXT vkiHdrMetadataEXT(VkXYColorEXT displayPrimaryRed, VkXYColorEXT displayPrimaryGreen, VkXYColorEXT displayPrimaryBlue, VkXYColorEXT whitePoint, float maxLuminance, float minLuminance, float maxContentLightLevel, float maxFrameAverageLightLevel) {
...
inline VkDebugUtilsObjectNameInfoEXT vkiDebugUtilsObjectNameInfoEXT(VkObjectType objectType, uint64_t objectHandle, const char* pObjectName) {
...
inline VkDebugUtilsObjectTagInfoEXT vkiDebugUtilsObjectTagInfoEXT(VkObjectType objectType, uint64_t objectHandle, uint64_t tagName, size_t tagSize, const void* pTag) {
...
// inline VkDebugUtilsLabelEXT vkiDebugUtilsLabelEXT(const char* pLabelName, float color[4]) {
...
inline VkDebugUtilsMessengerCreateInfoEXT vkiDebugUtilsMessengerCreateInfoEXT(VkDebugUtilsMessageSeverityFlagsEXT messageSeverity, VkDebugUtilsMessageTypeFlagsEXT messageType, PFN_vkDebugUtilsMessengerCallbackEXT pfnUserCallback, void* pUserData) {
...
inline VkSamplerReductionModeCreateInfoEXT vkiSamplerReductionModeCreateInfoEXT(VkSamplerReductionModeEXT reductionMode) {
...
inline VkPhysicalDeviceSamplerFilterMinmaxPropertiesEXT vkiPhysicalDeviceSamplerFilterMinmaxPropertiesEXT(VkBool32 filterMinmaxSingleComponentFormats, VkBool32 filterMinmaxImageComponentMapping) {
    ...
    PhysicalDeviceSamplerFilterMinmaxPropertiesEXT.filterMinmaxSingleComponentFormats = filterMinmaxSingleComponentFormats;
    PhysicalDeviceSamplerFilterMinmaxPropertiesEXT.filterMinmaxImageComponentMapping = filterMinmaxImageComponentMapping;
    return PhysicalDeviceSamplerFilterMinmaxPropertiesEXT;
}

inline VkPhysicalDeviceInlineUniformBlockFeaturesEXT vkiPhysicalDeviceInlineUniformBlockFeaturesEXT(VkBool32 inlineUniformBlock, VkBool32 descriptorBindingInlineUniformBlockUpdateAfterBind) {
    ...
    PhysicalDeviceInlineUniformBlockFeaturesEXT.inlineUniformBlock = inlineUniformBlock;
    PhysicalDeviceInlineUniformBlockFeaturesEXT.descriptorBindingInlineUniformBlockUpdateAfterBind = descriptorBindingInlineUniformBlockUpdateAfterBind;
    return PhysicalDeviceInlineUniformBlockFeaturesEXT;
}

inline VkPhysicalDeviceInlineUniformBlockPropertiesEXT vkiPhysicalDeviceInlineUniformBlockPropertiesEXT(uint32_t maxInlineUniformBlockSize, uint32_t maxPerStageDescriptorInlineUniformBlocks, uint32_t maxPerStageDescriptorUpdateAfterBindInlineUniformBlocks, uint32_t maxDescriptorSetInlineUniformBlocks, uint32_t maxDescriptorSetUpdateAfterBindInlineUniformBlocks) {
    VkPhysicalDeviceInlineUniformBlockPropertiesEXT PhysicalDeviceInlineUniformBlockPropertiesEXT = {};
    ...
    PhysicalDeviceInlineUniformBlockPropertiesEXT.maxInlineUniformBlockSize = maxInlineUniformBlockSize;
    PhysicalDeviceInlineUniformBlockPropertiesEXT.maxPerStageDescriptorInlineUniformBlocks = maxPerStageDescriptorInlineUniformBlocks;
    PhysicalDeviceInlineUniformBlockPropertiesEXT.maxPerStageDescriptorUpdateAfterBindInlineUniformBlocks = maxPerStageDescriptorUpdateAfterBindInlineUniformBlocks;
    PhysicalDeviceInlineUniformBlockPropertiesEXT.maxDescriptorSetInlineUniformBlocks = maxDescriptorSetInlineUniformBlocks;
    PhysicalDeviceInlineUniformBlockPropertiesEXT.maxDescriptorSetUpdateAfterBindInlineUniformBlocks = maxDescriptorSetUpdateAfterBindInlineUniformBlocks;
    return PhysicalDeviceInlineUniformBlockPropertiesEXT;
}

inline VkWriteDescriptorSetInlineUniformBlockEXT vkiWriteDescriptorSetInlineUniformBlockEXT(uint32_t dataSize, const void* pData) {
    VkWriteDescriptorSetInlineUniformBlockEXT WriteDescriptorSetInlineUniformBlockEXT = {};
...
inline VkDescriptorPoolInlineUniformBlockCreateInfoEXT vkiDescriptorPoolInlineUniformBlockCreateInfoEXT(uint32_t maxInlineUniformBlockBindings) {
    VkDescriptorPoolInlineUniformBlockCreateInfoEXT DescriptorPoolInlineUniformBlockCreateInfoEXT = {};
    ...
    DescriptorPoolInlineUniformBlockCreateInfoEXT.maxInlineUniformBlockBindings = maxInlineUniformBlockBindings;
...
inline VkSampleLocationsInfoEXT vkiSampleLocationsInfoEXT(VkSampleCountFlagBits sampleLocationsPerPixel, VkExtent2D sampleLocationGridSize, uint32_t sampleLocationsCount, const VkSampleLocationEXT* pSampleLocations) {
...
inline VkAttachmentSampleLocationsEXT vkiAttachmentSampleLocationsEXT(uint32_t attachmentIndex, VkSampleLocationsInfoEXT sampleLocationsInfo) {
...
inline VkSubpassSampleLocationsEXT vkiSubpassSampleLocationsEXT(uint32_t subpassIndex, VkSampleLocationsInfoEXT sampleLocationsInfo) {
...
inline VkRenderPassSampleLocationsBeginInfoEXT vkiRenderPassSampleLocationsBeginInfoEXT(uint32_t attachmentInitialSampleLocationsCount, const VkAttachmentSampleLocationsEXT* pAttachmentInitialSampleLocations, uint32_t postSubpassSampleLocationsCount, const VkSubpassSampleLocationsEXT* pPostSubpassSampleLocations) {
    ...
    RenderPassSampleLocationsBeginInfoEXT.attachmentInitialSampleLocationsCount = attachmentInitialSampleLocationsCount;
    RenderPassSampleLocationsBeginInfoEXT.pAttachmentInitialSampleLocations = pAttachmentInitialSampleLocations;
    RenderPassSampleLocationsBeginInfoEXT.postSubpassSampleLocationsCount = postSubpassSampleLocationsCount;
    RenderPassSampleLocationsBeginInfoEXT.pPostSubpassSampleLocations = pPostSubpassSampleLocations;
    return RenderPassSampleLocationsBeginInfoEXT;
}

inline VkPipelineSampleLocationsStateCreateInfoEXT vkiPipelineSampleLocationsStateCreateInfoEXT(VkBool32 sampleLocationsEnable, VkSampleLocationsInfoEXT sampleLocationsInfo) {
    ...
    PipelineSampleLocationsStateCreateInfoEXT.sampleLocationsEnable = sampleLocationsEnable;
    PipelineSampleLocationsStateCreateInfoEXT.sampleLocationsInfo = sampleLocationsInfo;
    return PipelineSampleLocationsStateCreateInfoEXT;
}

// inline VkPhysicalDeviceSampleLocationsPropertiesEXT vkiPhysicalDeviceSampleLocationsPropertiesEXT(VkSampleCountFlags sampleLocationSampleCounts, VkExtent2D maxSampleLocationGridSize, float sampleLocationCoordinateRange[2], uint32_t sampleLocationSubPixelBits, VkBool32 variableSampleLocations) {
...
//     PhysicalDeviceSampleLocationsPropertiesEXT.sampleLocationSampleCounts = sampleLocationSampleCounts;
//     PhysicalDeviceSampleLocationsPropertiesEXT.maxSampleLocationGridSize = maxSampleLocationGridSize;
//     PhysicalDeviceSampleLocationsPropertiesEXT.sampleLocationCoordinateRange[2] = sampleLocationCoordinateRange[2];
//     PhysicalDeviceSampleLocationsPropertiesEXT.sampleLocationSubPixelBits = sampleLocationSubPixelBits;
//     PhysicalDeviceSampleLocationsPropertiesEXT.variableSampleLocations = variableSampleLocations;
//     return PhysicalDeviceSampleLocationsPropertiesEXT;
// }

inline VkMultisamplePropertiesEXT vkiMultisamplePropertiesEXT(VkExtent2D maxSampleLocationGridSize) {
    ...
    MultisamplePropertiesEXT.maxSampleLocationGridSize = maxSampleLocationGridSize;
    return MultisamplePropertiesEXT;
}

inline VkPhysicalDeviceBlendOperationAdvancedFeaturesEXT vkiPhysicalDeviceBlendOperationAdvancedFeaturesEXT(VkBool32 advancedBlendCoherentOperations) {
    ...
    PhysicalDeviceBlendOperationAdvancedFeaturesEXT.advancedBlendCoherentOperations = advancedBlendCoherentOperations;
...
inline VkPhysicalDeviceBlendOperationAdvancedPropertiesEXT vkiPhysicalDeviceBlendOperationAdvancedPropertiesEXT(uint32_t advancedBlendMaxColorAttachments, VkBool32 advancedBlendIndependentBlend, VkBool32 advancedBlendNonPremultipliedSrcColor, VkBool32 advancedBlendNonPremultipliedDstColor, VkBool32 advancedBlendCorrelatedOverlap, VkBool32 advancedBlendAllOperations) {
    ...
    PhysicalDeviceBlendOperationAdvancedPropertiesEXT.advancedBlendMaxColorAttachments = advancedBlendMaxColorAttachments;
    PhysicalDeviceBlendOperationAdvancedPropertiesEXT.advancedBlendIndependentBlend = advancedBlendIndependentBlend;
    PhysicalDeviceBlendOperationAdvancedPropertiesEXT.advancedBlendNonPremultipliedSrcColor = advancedBlendNonPremultipliedSrcColor;
    PhysicalDeviceBlendOperationAdvancedPropertiesEXT.advancedBlendNonPremultipliedDstColor = advancedBlendNonPremultipliedDstColor;
    PhysicalDeviceBlendOperationAdvancedPropertiesEXT.advancedBlendCorrelatedOverlap = advancedBlendCorrelatedOverlap;
    PhysicalDeviceBlendOperationAdvancedPropertiesEXT.advancedBlendAllOperations = advancedBlendAllOperations;
    return PhysicalDeviceBlendOperationAdvancedPropertiesEXT;
}

inline VkPipelineColorBlendAdvancedStateCreateInfoEXT vkiPipelineColorBlendAdvancedStateCreateInfoEXT(VkBool32 srcPremultiplied, VkBool32 dstPremultiplied, VkBlendOverlapEXT blendOverlap) {
    ...
    PipelineColorBlendAdvancedStateCreateInfoEXT.srcPremultiplied = srcPremultiplied;
    PipelineColorBlendAdvancedStateCreateInfoEXT.dstPremultiplied = dstPremultiplied;
...
inline VkPipelineCoverageToColorStateCreateInfoNV vkiPipelineCoverageToColorStateCreateInfoNV(VkBool32 coverageToColorEnable, uint32_t coverageToColorLocation) {
    ...
    PipelineCoverageToColorStateCreateInfoNV.coverageToColorEnable = coverageToColorEnable;
    PipelineCoverageToColorStateCreateInfoNV.coverageToColorLocation = coverageToColorLocation;
    return PipelineCoverageToColorStateCreateInfoNV;
}

inline VkPipelineCoverageModulationStateCreateInfoNV vkiPipelineCoverageModulationStateCreateInfoNV(VkCoverageModulationModeNV coverageModulationMode, VkBool32 coverageModulationTableEnable, uint32_t coverageModulationTableCount, const float* pCoverageModulationTable) {
    ...
    PipelineCoverageModulationStateCreateInfoNV.coverageModulationMode = coverageModulationMode;
    PipelineCoverageModulationStateCreateInfoNV.coverageModulationTableEnable = coverageModulationTableEnable;
    PipelineCoverageModulationStateCreateInfoNV.coverageModulationTableCount = coverageModulationTableCount;
    PipelineCoverageModulationStateCreateInfoNV.pCoverageModulationTable = pCoverageModulationTable;
    return PipelineCoverageModulationStateCreateInfoNV;
}

inline VkPhysicalDeviceShaderSMBuiltinsPropertiesNV vkiPhysicalDeviceShaderSMBuiltinsPropertiesNV(uint32_t shaderSMCount, uint32_t shaderWarpsPerSM) {
    ...
    PhysicalDeviceShaderSMBuiltinsPropertiesNV.shaderWarpsPerSM = shaderWarpsPerSM;
    return PhysicalDeviceShaderSMBuiltinsPropertiesNV;
}

inline VkPhysicalDeviceShaderSMBuiltinsFeaturesNV vkiPhysicalDeviceShaderSMBuiltinsFeaturesNV(VkBool32 shaderSMBuiltins) {
...
inline VkDrmFormatModifierPropertiesEXT vkiDrmFormatModifierPropertiesEXT(uint64_t drmFormatModifier, uint32_t drmFormatModifierPlaneCount, VkFormatFeatureFlags drmFormatModifierTilingFeatures) {
    ...
    DrmFormatModifierPropertiesEXT.drmFormatModifierPlaneCount = drmFormatModifierPlaneCount;
    DrmFormatModifierPropertiesEXT.drmFormatModifierTilingFeatures = drmFormatModifierTilingFeatures;
    return DrmFormatModifierPropertiesEXT;
}

inline VkDrmFormatModifierPropertiesListEXT vkiDrmFormatModifierPropertiesListEXT(uint32_t drmFormatModifierCount, VkDrmFormatModifierPropertiesEXT* pDrmFormatModifierProperties) {
    ...
    DrmFormatModifierPropertiesListEXT.drmFormatModifierCount = drmFormatModifierCount;
    DrmFormatModifierPropertiesListEXT.pDrmFormatModifierProperties = pDrmFormatModifierProperties;
    return DrmFormatModifierPropertiesListEXT;
}

inline VkPhysicalDeviceImageDrmFormatModifierInfoEXT vkiPhysicalDeviceImageDrmFormatModifierInfoEXT(uint64_t drmFormatModifier, VkSharingMode sharingMode, uint32_t queueFamilyIndexCount, const uint32_t* pQueueFamilyIndices) {
    ...
    PhysicalDeviceImageDrmFormatModifierInfoEXT.drmFormatModifier = drmFormatModifier;
    PhysicalDeviceImageDrmFormatModifierInfoEXT.sharingMode = sharingMode;
    PhysicalDeviceImageDrmFormatModifierInfoEXT.queueFamilyIndexCount = queueFamilyIndexCount;
    PhysicalDeviceImageDrmFormatModifierInfoEXT.pQueueFamilyIndices = pQueueFamilyIndices;
    return PhysicalDeviceImageDrmFormatModifierInfoEXT;
}

inline VkImageDrmFormatModifierListCreateInfoEXT vkiImageDrmFormatModifierListCreateInfoEXT(uint32_t drmFormatModifierCount, const uint64_t* pDrmFormatModifiers) {
    ...
    ImageDrmFormatModifierListCreateInfoEXT.drmFormatModifierCount = drmFormatModifierCount;
    ImageDrmFormatModifierListCreateInfoEXT.pDrmFormatModifiers = pDrmFormatModifiers;
    return ImageDrmFormatModifierListCreateInfoEXT;
}

inline VkImageDrmFormatModifierExplicitCreateInfoEXT vkiImageDrmFormatModifierExplicitCreateInfoEXT(uint64_t drmFormatModifier, uint32_t drmFormatModifierPlaneCount, const VkSubresourceLayout* pPlaneLayouts) {
    ...
    ImageDrmFormatModifierExplicitCreateInfoEXT.drmFormatModifier = drmFormatModifier;
    ImageDrmFormatModifierExplicitCreateInfoEXT.drmFormatModifierPlaneCount = drmFormatModifierPlaneCount;
    ImageDrmFormatModifierExplicitCreateInfoEXT.pPlaneLayouts = pPlaneLayouts;
    return ImageDrmFormatModifierExplicitCreateInfoEXT;
}

inline VkImageDrmFormatModifierPropertiesEXT vkiImageDrmFormatModifierPropertiesEXT(uint64_t drmFormatModifier) {
...
inline VkValidationCacheCreateInfoEXT vkiValidationCacheCreateInfoEXT(size_t initialDataSize, const void* pInitialData) {
...
inline VkShaderModuleValidationCacheCreateInfoEXT vkiShaderModuleValidationCacheCreateInfoEXT(VkValidationCacheEXT validationCache) {
...
inline VkDescriptorSetLayoutBindingFlagsCreateInfoEXT vkiDescriptorSetLayoutBindingFlagsCreateInfoEXT(uint32_t bindingCount, const VkDescriptorBindingFlagsEXT* pBindingFlags) {
...
inline VkPhysicalDeviceDescriptorIndexingFeaturesEXT vkiPhysicalDeviceDescriptorIndexingFeaturesEXT(VkBool32 shaderInputAttachmentArrayDynamicIndexing, VkBool32 shaderUniformTexelBufferArrayDynamicIndexing, VkBool32 shaderStorageTexelBufferArrayDynamicIndexing, VkBool32 shaderUniformBufferArrayNonUniformIndexing, VkBool32 shaderSampledImageArrayNonUniformIndexing, VkBool32 shaderStorageBufferArrayNonUniformIndexing, VkBool32 shaderStorageImageArrayNonUniformIndexing, VkBool32 shaderInputAttachmentArrayNonUniformIndexing, VkBool32 shaderUniformTexelBufferArrayNonUniformIndexing, VkBool32 shaderStorageTexelBufferArrayNonUniformIndexing, VkBool32 descriptorBindingUniformBufferUpdateAfterBind, VkBool32 descriptorBindingSampledImageUpdateAfterBind, VkBool32 descriptorBindingStorageImageUpdateAfterBind, VkBool32 descriptorBindingStorageBufferUpdateAfterBind, VkBool32 descriptorBindingUniformTexelBufferUpdateAfterBind, VkBool32 descriptorBindingStorageTexelBufferUpdateAfterBind, VkBool32 descriptorBindingUpdateUnusedWhilePending, VkBool32 descriptorBindingPartiallyBound, VkBool32 descriptorBindingVariableDescriptorCount, VkBool32 runtimeDescriptorArray) {
    ...
    PhysicalDeviceDescriptorIndexingFeaturesEXT.shaderInputAttachmentArrayDynamicIndexing = shaderInputAttachmentArrayDynamicIndexing;
    PhysicalDeviceDescriptorIndexingFeaturesEXT.shaderUniformTexelBufferArrayDynamicIndexing = shaderUniformTexelBufferArrayDynamicIndexing;
    PhysicalDeviceDescriptorIndexingFeaturesEXT.shaderStorageTexelBufferArrayDynamicIndexing = shaderStorageTexelBufferArrayDynamicIndexing;
    PhysicalDeviceDescriptorIndexingFeaturesEXT.shaderUniformBufferArrayNonUniformIndexing = shaderUniformBufferArrayNonUniformIndexing;
    PhysicalDeviceDescriptorIndexingFeaturesEXT.shaderSampledImageArrayNonUniformIndexing = shaderSampledImageArrayNonUniformIndexing;
    PhysicalDeviceDescriptorIndexingFeaturesEXT.shaderStorageBufferArrayNonUniformIndexing = shaderStorageBufferArrayNonUniformIndexing;
    PhysicalDeviceDescriptorIndexingFeaturesEXT.shaderStorageImageArrayNonUniformIndexing = shaderStorageImageArrayNonUniformIndexing;
    PhysicalDeviceDescriptorIndexingFeaturesEXT.shaderInputAttachmentArrayNonUniformIndexing = shaderInputAttachmentArrayNonUniformIndexing;
    PhysicalDeviceDescriptorIndexingFeaturesEXT.shaderUniformTexelBufferArrayNonUniformIndexing = shaderUniformTexelBufferArrayNonUniformIndexing;
    PhysicalDeviceDescriptorIndexingFeaturesEXT.shaderStorageTexelBufferArrayNonUniformIndexing = shaderStorageTexelBufferArrayNonUniformIndexing;
    PhysicalDeviceDescriptorIndexingFeaturesEXT.descriptorBindingUniformBufferUpdateAfterBind = descriptorBindingUniformBufferUpdateAfterBind;
    PhysicalDeviceDescriptorIndexingFeaturesEXT.descriptorBindingSampledImageUpdateAfterBind = descriptorBindingSampledImageUpdateAfterBind;
    PhysicalDeviceDescriptorIndexingFeaturesEXT.descriptorBindingStorageImageUpdateAfterBind = descriptorBindingStorageImageUpdateAfterBind;
    PhysicalDeviceDescriptorIndexingFeaturesEXT.descriptorBindingStorageBufferUpdateAfterBind = descriptorBindingStorageBufferUpdateAfterBind;
    PhysicalDeviceDescriptorIndexingFeaturesEXT.descriptorBindingUniformTexelBufferUpdateAfterBind = descriptorBindingUniformTexelBufferUpdateAfterBind;
    PhysicalDeviceDescriptorIndexingFeaturesEXT.descriptorBindingStorageTexelBufferUpdateAfterBind = descriptorBindingStorageTexelBufferUpdateAfterBind;
    PhysicalDeviceDescriptorIndexingFeaturesEXT.descriptorBindingUpdateUnusedWhilePending = descriptorBindingUpdateUnusedWhilePending;
    PhysicalDeviceDescriptorIndexingFeaturesEXT.descriptorBindingPartiallyBound = descriptorBindingPartiallyBound;
    PhysicalDeviceDescriptorIndexingFeaturesEXT.descriptorBindingVariableDescriptorCount = descriptorBindingVariableDescriptorCount;
    PhysicalDeviceDescriptorIndexingFeaturesEXT.runtimeDescriptorArray = runtimeDescriptorArray;
    return PhysicalDeviceDescriptorIndexingFeaturesEXT;
}

inline VkPhysicalDeviceDescriptorIndexingPropertiesEXT vkiPhysicalDeviceDescriptorIndexingPropertiesEXT(uint32_t maxUpdateAfterBindDescriptorsInAllPools, VkBool32 shaderUniformBufferArrayNonUniformIndexingNative, VkBool32 shaderSampledImageArrayNonUniformIndexingNative, VkBool32 shaderStorageBufferArrayNonUniformIndexingNative, VkBool32 shaderStorageImageArrayNonUniformIndexingNative, VkBool32 shaderInputAttachmentArrayNonUniformIndexingNative, VkBool32 robustBufferAccessUpdateAfterBind, VkBool32 quadDivergentImplicitLod, uint32_t maxPerStageDescriptorUpdateAfterBindSamplers, uint32_t maxPerStageDescriptorUpdateAfterBindUniformBuffers, uint32_t maxPerStageDescriptorUpdateAfterBindStorageBuffers, uint32_t maxPerStageDescriptorUpdateAfterBindSampledImages, uint32_t maxPerStageDescriptorUpdateAfterBindStorageImages, uint32_t maxPerStageDescriptorUpdateAfterBindInputAttachments, uint32_t maxPerStageUpdateAfterBindResources, uint32_t maxDescriptorSetUpdateAfterBindSamplers, uint32_t maxDescriptorSetUpdateAfterBindUniformBuffers, uint32_t maxDescriptorSetUpdateAfterBindUniformBuffersDynamic, uint32_t maxDescriptorSetUpdateAfterBindStorageBuffers, uint32_t maxDescriptorSetUpdateAfterBindStorageBuffersDynamic, uint32_t maxDescriptorSetUpdateAfterBindSampledImages, uint32_t maxDescriptorSetUpdateAfterBindStorageImages, uint32_t maxDescriptorSetUpdateAfterBindInputAttachments) {
    VkPhysicalDeviceDescriptorIndexingPropertiesEXT PhysicalDeviceDescriptorIndexingPropertiesEXT = {};
    ...
    PhysicalDeviceDescriptorIndexingPropertiesEXT.maxUpdateAfterBindDescriptorsInAllPools = maxUpdateAfterBindDescriptorsInAllPools;
    PhysicalDeviceDescriptorIndexingPropertiesEXT.shaderUniformBufferArrayNonUniformIndexingNative = shaderUniformBufferArrayNonUniformIndexingNative;
    PhysicalDeviceDescriptorIndexingPropertiesEXT.shaderSampledImageArrayNonUniformIndexingNative = shaderSampledImageArrayNonUniformIndexingNative;
    PhysicalDeviceDescriptorIndexingPropertiesEXT.shaderStorageBufferArrayNonUniformIndexingNative = shaderStorageBufferArrayNonUniformIndexingNative;
    PhysicalDeviceDescriptorIndexingPropertiesEXT.shaderStorageImageArrayNonUniformIndexingNative = shaderStorageImageArrayNonUniformIndexingNative;
    PhysicalDeviceDescriptorIndexingPropertiesEXT.shaderInputAttachmentArrayNonUniformIndexingNative = shaderInputAttachmentArrayNonUniformIndexingNative;
    PhysicalDeviceDescriptorIndexingPropertiesEXT.robustBufferAccessUpdateAfterBind = robustBufferAccessUpdateAfterBind;
    PhysicalDeviceDescriptorIndexingPropertiesEXT.quadDivergentImplicitLod = quadDivergentImplicitLod;
    PhysicalDeviceDescriptorIndexingPropertiesEXT.maxPerStageDescriptorUpdateAfterBindSamplers = maxPerStageDescriptorUpdateAfterBindSamplers;
    PhysicalDeviceDescriptorIndexingPropertiesEXT.maxPerStageDescriptorUpdateAfterBindUniformBuffers = maxPerStageDescriptorUpdateAfterBindUniformBuffers;
    PhysicalDeviceDescriptorIndexingPropertiesEXT.maxPerStageDescriptorUpdateAfterBindStorageBuffers = maxPerStageDescriptorUpdateAfterBindStorageBuffers;
    PhysicalDeviceDescriptorIndexingPropertiesEXT.maxPerStageDescriptorUpdateAfterBindSampledImages = maxPerStageDescriptorUpdateAfterBindSampledImages;
    PhysicalDeviceDescriptorIndexingPropertiesEXT.maxPerStageDescriptorUpdateAfterBindStorageImages = maxPerStageDescriptorUpdateAfterBindStorageImages;
    PhysicalDeviceDescriptorIndexingPropertiesEXT.maxPerStageDescriptorUpdateAfterBindInputAttachments = maxPerStageDescriptorUpdateAfterBindInputAttachments;
    PhysicalDeviceDescriptorIndexingPropertiesEXT.maxPerStageUpdateAfterBindResources = maxPerStageUpdateAfterBindResources;
    PhysicalDeviceDescriptorIndexingPropertiesEXT.maxDescriptorSetUpdateAfterBindSamplers = maxDescriptorSetUpdateAfterBindSamplers;
    PhysicalDeviceDescriptorIndexingPropertiesEXT.maxDescriptorSetUpdateAfterBindUniformBuffers = maxDescriptorSetUpdateAfterBindUniformBuffers;
    PhysicalDeviceDescriptorIndexingPropertiesEXT.maxDescriptorSetUpdateAfterBindUniformBuffersDynamic = maxDescriptorSetUpdateAfterBindUniformBuffersDynamic;
    PhysicalDeviceDescriptorIndexingPropertiesEXT.maxDescriptorSetUpdateAfterBindStorageBuffers = maxDescriptorSetUpdateAfterBindStorageBuffers;
    PhysicalDeviceDescriptorIndexingPropertiesEXT.maxDescriptorSetUpdateAfterBindStorageBuffersDynamic = maxDescriptorSetUpdateAfterBindStorageBuffersDynamic;
    PhysicalDeviceDescriptorIndexingPropertiesEXT.maxDescriptorSetUpdateAfterBindSampledImages = maxDescriptorSetUpdateAfterBindSampledImages;
    PhysicalDeviceDescriptorIndexingPropertiesEXT.maxDescriptorSetUpdateAfterBindStorageImages = maxDescriptorSetUpdateAfterBindStorageImages;
    PhysicalDeviceDescriptorIndexingPropertiesEXT.maxDescriptorSetUpdateAfterBindInputAttachments = maxDescriptorSetUpdateAfterBindInputAttachments;
    return PhysicalDeviceDescriptorIndexingPropertiesEXT;
}

inline VkDescriptorSetVariableDescriptorCountAllocateInfoEXT vkiDescriptorSetVariableDescriptorCountAllocateInfoEXT(uint32_t descriptorSetCount, const uint32_t* pDescriptorCounts) {
    ...
    DescriptorSetVariableDescriptorCountAllocateInfoEXT.descriptorSetCount = descriptorSetCount;
    DescriptorSetVariableDescriptorCountAllocateInfoEXT.pDescriptorCounts = pDescriptorCounts;
    return DescriptorSetVariableDescriptorCountAllocateInfoEXT;
}

inline VkDescriptorSetVariableDescriptorCountLayoutSupportEXT vkiDescriptorSetVariableDescriptorCountLayoutSupportEXT(uint32_t maxVariableDescriptorCount) {
    VkDescriptorSetVariableDescriptorCountLayoutSupportEXT DescriptorSetVariableDescriptorCountLayoutSupportEXT = {};
    ...
    DescriptorSetVariableDescriptorCountLayoutSupportEXT.maxVariableDescriptorCount = maxVariableDescriptorCount;
    return DescriptorSetVariableDescriptorCountLayoutSupportEXT;
}

inline VkShadingRatePaletteNV vkiShadingRatePaletteNV(uint32_t shadingRatePaletteEntryCount, const VkShadingRatePaletteEntryNV* pShadingRatePaletteEntries) {
    VkShadingRatePaletteNV ShadingRatePaletteNV = {};
    ShadingRatePaletteNV.shadingRatePaletteEntryCount = shadingRatePaletteEntryCount;
    ShadingRatePaletteNV.pShadingRatePaletteEntries = pShadingRatePaletteEntries;
    return ShadingRatePaletteNV;
}

inline VkPipelineViewportShadingRateImageStateCreateInfoNV vkiPipelineViewportShadingRateImageStateCreateInfoNV(VkBool32 shadingRateImageEnable, uint32_t viewportCount, const VkShadingRatePaletteNV* pShadingRatePalettes) {
    ...
    PipelineViewportShadingRateImageStateCreateInfoNV.shadingRateImageEnable = shadingRateImageEnable;
    PipelineViewportShadingRateImageStateCreateInfoNV.viewportCount = viewportCount;
    PipelineViewportShadingRateImageStateCreateInfoNV.pShadingRatePalettes = pShadingRatePalettes;
    return PipelineViewportShadingRateImageStateCreateInfoNV;
}

inline VkPhysicalDeviceShadingRateImageFeaturesNV vkiPhysicalDeviceShadingRateImageFeaturesNV(VkBool32 shadingRateImage, VkBool32 shadingRateCoarseSampleOrder) {
    ...
    PhysicalDeviceShadingRateImageFeaturesNV.shadingRateCoarseSampleOrder = shadingRateCoarseSampleOrder;
    return PhysicalDeviceShadingRateImageFeaturesNV;
}

inline VkPhysicalDeviceShadingRateImagePropertiesNV vkiPhysicalDeviceShadingRateImagePropertiesNV(VkExtent2D shadingRateTexelSize, uint32_t shadingRatePaletteSize, uint32_t shadingRateMaxCoarseSamples) {
    ...
    PhysicalDeviceShadingRateImagePropertiesNV.shadingRateTexelSize = shadingRateTexelSize;
    PhysicalDeviceShadingRateImagePropertiesNV.shadingRatePaletteSize = shadingRatePaletteSize;
    PhysicalDeviceShadingRateImagePropertiesNV.shadingRateMaxCoarseSamples = shadingRateMaxCoarseSamples;
    return PhysicalDeviceShadingRateImagePropertiesNV;
}

inline VkCoarseSampleLocationNV vkiCoarseSampleLocationNV(uint32_t pixelX, uint32_t pixelY, uint32_t sample) {
...
inline VkCoarseSampleOrderCustomNV vkiCoarseSampleOrderCustomNV(VkShadingRatePaletteEntryNV shadingRate, uint32_t sampleCount, uint32_t sampleLocationCount, const VkCoarseSampleLocationNV* pSampleLocations) {
...
inline VkPipelineViewportCoarseSampleOrderStateCreateInfoNV vkiPipelineViewportCoarseSampleOrderStateCreateInfoNV(VkCoarseSampleOrderTypeNV sampleOrderType, uint32_t customSampleOrderCount, const VkCoarseSampleOrderCustomNV* pCustomSampleOrders) {
    ...
    PipelineViewportCoarseSampleOrderStateCreateInfoNV.sampleOrderType = sampleOrderType;
    PipelineViewportCoarseSampleOrderStateCreateInfoNV.customSampleOrderCount = customSampleOrderCount;
    PipelineViewportCoarseSampleOrderStateCreateInfoNV.pCustomSampleOrders = pCustomSampleOrders;
    return PipelineViewportCoarseSampleOrderStateCreateInfoNV;
}

inline VkRayTracingShaderGroupCreateInfoNV vkiRayTracingShaderGroupCreateInfoNV(VkRayTracingShaderGroupTypeNV type, uint32_t generalShader, uint32_t closestHitShader, uint32_t anyHitShader, uint32_t intersectionShader) {
...
inline VkGeometryTrianglesNV vkiGeometryTrianglesNV(VkBuffer vertexData, VkDeviceSize vertexOffset, uint32_t vertexCount, VkDeviceSize vertexStride, VkFormat vertexFormat, VkBuffer indexData, VkDeviceSize indexOffset, uint32_t indexCount, VkIndexType indexType, VkBuffer transformData, VkDeviceSize transformOffset) {
...
inline VkGeometryAABBNV vkiGeometryAABBNV(VkBuffer aabbData, uint32_t numAABBs, uint32_t stride, VkDeviceSize offset) {
...
inline VkGeometryDataNV vkiGeometryDataNV(VkGeometryTrianglesNV triangles, VkGeometryAABBNV aabbs) {
...
inline VkGeometryNV vkiGeometryNV(VkGeometryTypeNV geometryType, VkGeometryDataNV geometry) {
...
inline VkAccelerationStructureInfoNV vkiAccelerationStructureInfoNV(VkAccelerationStructureTypeNV type, uint32_t instanceCount, uint32_t geometryCount, const VkGeometryNV* pGeometries) {
...
inline VkAccelerationStructureCreateInfoNV vkiAccelerationStructureCreateInfoNV(VkDeviceSize compactedSize, VkAccelerationStructureInfoNV info) {
...
inline VkBindAccelerationStructureMemoryInfoNV vkiBindAccelerationStructureMemoryInfoNV(VkAccelerationStructureNV accelerationStructure, VkDeviceMemory memory, VkDeviceSize memoryOffset, uint32_t deviceIndexCount, const uint32_t* pDeviceIndices) {
    ...
    BindAccelerationStructureMemoryInfoNV.accelerationStructure = accelerationStructure;
...
inline VkWriteDescriptorSetAccelerationStructureNV vkiWriteDescriptorSetAccelerationStructureNV(uint32_t accelerationStructureCount, const VkAccelerationStructureNV* pAccelerationStructures) {
    ...
    WriteDescriptorSetAccelerationStructureNV.accelerationStructureCount = accelerationStructureCount;
    WriteDescriptorSetAccelerationStructureNV.pAccelerationStructures = pAccelerationStructures;
    return WriteDescriptorSetAccelerationStructureNV;
}

inline VkAccelerationStructureMemoryRequirementsInfoNV vkiAccelerationStructureMemoryRequirementsInfoNV(VkAccelerationStructureMemoryRequirementsTypeNV type, VkAccelerationStructureNV accelerationStructure) {
...
inline VkPhysicalDeviceRayTracingPropertiesNV vkiPhysicalDeviceRayTracingPropertiesNV(uint32_t shaderGroupHandleSize, uint32_t maxRecursionDepth, uint32_t maxShaderGroupStride, uint32_t shaderGroupBaseAlignment, uint64_t maxGeometryCount, uint64_t maxInstanceCount, uint64_t maxTriangleCount, uint32_t maxDescriptorSetAccelerationStructures) {
    ...
    PhysicalDeviceRayTracingPropertiesNV.shaderGroupHandleSize = shaderGroupHandleSize;
    PhysicalDeviceRayTracingPropertiesNV.maxRecursionDepth = maxRecursionDepth;
    PhysicalDeviceRayTracingPropertiesNV.maxShaderGroupStride = maxShaderGroupStride;
    PhysicalDeviceRayTracingPropertiesNV.shaderGroupBaseAlignment = shaderGroupBaseAlignment;
    ...
    PhysicalDeviceRayTracingPropertiesNV.maxDescriptorSetAccelerationStructures = maxDescriptorSetAccelerationStructures;
    return PhysicalDeviceRayTracingPropertiesNV;
}

inline VkPhysicalDeviceRepresentativeFragmentTestFeaturesNV vkiPhysicalDeviceRepresentativeFragmentTestFeaturesNV(VkBool32 representativeFragmentTest) {
    ...
    PhysicalDeviceRepresentativeFragmentTestFeaturesNV.representativeFragmentTest = representativeFragmentTest;
    return PhysicalDeviceRepresentativeFragmentTestFeaturesNV;
}

inline VkPipelineRepresentativeFragmentTestStateCreateInfoNV vkiPipelineRepresentativeFragmentTestStateCreateInfoNV(VkBool32 representativeFragmentTestEnable) {
    ...
    PipelineRepresentativeFragmentTestStateCreateInfoNV.representativeFragmentTestEnable = representativeFragmentTestEnable;
    return PipelineRepresentativeFragmentTestStateCreateInfoNV;
}

inline VkPhysicalDeviceImageViewImageFormatInfoEXT vkiPhysicalDeviceImageViewImageFormatInfoEXT(VkImageViewType imageViewType) {
...
inline VkFilterCubicImageViewImageFormatPropertiesEXT vkiFilterCubicImageViewImageFormatPropertiesEXT(VkBool32 filterCubic, VkBool32 filterCubicMinmax ) {
    ...
    FilterCubicImageViewImageFormatPropertiesEXT.filterCubicMinmax = filterCubicMinmax;
    return FilterCubicImageViewImageFormatPropertiesEXT;
}

inline VkDeviceQueueGlobalPriorityCreateInfoEXT vkiDeviceQueueGlobalPriorityCreateInfoEXT(VkQueueGlobalPriorityEXT globalPriority) {
...
inline VkImportMemoryHostPointerInfoEXT vkiImportMemoryHostPointerInfoEXT(VkExternalMemoryHandleTypeFlagBits handleType, void* pHostPointer) {
...
inline VkMemoryHostPointerPropertiesEXT vkiMemoryHostPointerPropertiesEXT(uint32_t memoryTypeBits) {
...
inline VkPhysicalDeviceExternalMemoryHostPropertiesEXT vkiPhysicalDeviceExternalMemoryHostPropertiesEXT(VkDeviceSize minImportedHostPointerAlignment) {
    ...
    PhysicalDeviceExternalMemoryHostPropertiesEXT.minImportedHostPointerAlignment = minImportedHostPointerAlignment;
    return PhysicalDeviceExternalMemoryHostPropertiesEXT;
}

inline VkPipelineCompilerControlCreateInfoAMD vkiPipelineCompilerControlCreateInfoAMD(VkPipelineCompilerControlFlagsAMD compilerControlFlags) {
    ...
    PipelineCompilerControlCreateInfoAMD.compilerControlFlags = compilerControlFlags;
    return PipelineCompilerControlCreateInfoAMD;
}

inline VkCalibratedTimestampInfoEXT vkiCalibratedTimestampInfoEXT(VkTimeDomainEXT timeDomain) {
...
inline VkPhysicalDeviceShaderCorePropertiesAMD vkiPhysicalDeviceShaderCorePropertiesAMD(uint32_t shaderEngineCount, uint32_t shaderArraysPerEngineCount, uint32_t computeUnitsPerShaderArray, uint32_t simdPerComputeUnit, uint32_t wavefrontsPerSimd, uint32_t wavefrontSize, uint32_t sgprsPerSimd, uint32_t minSgprAllocation, uint32_t maxSgprAllocation, uint32_t sgprAllocationGranularity, uint32_t vgprsPerSimd, uint32_t minVgprAllocation, uint32_t maxVgprAllocation, uint32_t vgprAllocationGranularity) {
    ...
    PhysicalDeviceShaderCorePropertiesAMD.shaderArraysPerEngineCount = shaderArraysPerEngineCount;
    PhysicalDeviceShaderCorePropertiesAMD.computeUnitsPerShaderArray = computeUnitsPerShaderArray;
    ...
    PhysicalDeviceShaderCorePropertiesAMD.sgprAllocationGranularity = sgprAllocationGranularity;
    ...
    PhysicalDeviceShaderCorePropertiesAMD.vgprAllocationGranularity = vgprAllocationGranularity;
    return PhysicalDeviceShaderCorePropertiesAMD;
}

inline VkDeviceMemoryOverallocationCreateInfoAMD vkiDeviceMemoryOverallocationCreateInfoAMD(VkMemoryOverallocationBehaviorAMD overallocationBehavior) {
    VkDeviceMemoryOverallocationCreateInfoAMD DeviceMemoryOverallocationCreateInfoAMD = {};
    ...
    DeviceMemoryOverallocationCreateInfoAMD.overallocationBehavior = overallocationBehavior;
    return DeviceMemoryOverallocationCreateInfoAMD;
}

inline VkPhysicalDeviceVertexAttributeDivisorPropertiesEXT vkiPhysicalDeviceVertexAttributeDivisorPropertiesEXT(uint32_t maxVertexAttribDivisor) {
    ...
    PhysicalDeviceVertexAttributeDivisorPropertiesEXT.maxVertexAttribDivisor = maxVertexAttribDivisor;
    return PhysicalDeviceVertexAttributeDivisorPropertiesEXT;
}

inline VkVertexInputBindingDivisorDescriptionEXT vkiVertexInputBindingDivisorDescriptionEXT(uint32_t binding, uint32_t divisor) {
    VkVertexInputBindingDivisorDescriptionEXT VertexInputBindingDivisorDescriptionEXT = {};
...
inline VkPipelineVertexInputDivisorStateCreateInfoEXT vkiPipelineVertexInputDivisorStateCreateInfoEXT(uint32_t vertexBindingDivisorCount, const VkVertexInputBindingDivisorDescriptionEXT* pVertexBindingDivisors) {
    VkPipelineVertexInputDivisorStateCreateInfoEXT PipelineVertexInputDivisorStateCreateInfoEXT = {};
    ...
    PipelineVertexInputDivisorStateCreateInfoEXT.vertexBindingDivisorCount = vertexBindingDivisorCount;
    PipelineVertexInputDivisorStateCreateInfoEXT.pVertexBindingDivisors = pVertexBindingDivisors;
    return PipelineVertexInputDivisorStateCreateInfoEXT;
}

inline VkPhysicalDeviceVertexAttributeDivisorFeaturesEXT vkiPhysicalDeviceVertexAttributeDivisorFeaturesEXT(VkBool32 vertexAttributeInstanceRateDivisor, VkBool32 vertexAttributeInstanceRateZeroDivisor) {
    ...
    PhysicalDeviceVertexAttributeDivisorFeaturesEXT.vertexAttributeInstanceRateDivisor = vertexAttributeInstanceRateDivisor;
    PhysicalDeviceVertexAttributeDivisorFeaturesEXT.vertexAttributeInstanceRateZeroDivisor = vertexAttributeInstanceRateZeroDivisor;
    return PhysicalDeviceVertexAttributeDivisorFeaturesEXT;
}

inline VkPipelineCreationFeedbackEXT vkiPipelineCreationFeedbackEXT(uint64_t duration) {
...
inline VkPipelineCreationFeedbackCreateInfoEXT vkiPipelineCreationFeedbackCreateInfoEXT(VkPipelineCreationFeedbackEXT* pPipelineCreationFeedback, uint32_t pipelineStageCreationFeedbackCount, VkPipelineCreationFeedbackEXT* pPipelineStageCreationFeedbacks) {
    VkPipelineCreationFeedbackCreateInfoEXT PipelineCreationFeedbackCreateInfoEXT = {};
    ...
    PipelineCreationFeedbackCreateInfoEXT.pPipelineCreationFeedback = pPipelineCreationFeedback;
    PipelineCreationFeedbackCreateInfoEXT.pipelineStageCreationFeedbackCount = pipelineStageCreationFeedbackCount;
    PipelineCreationFeedbackCreateInfoEXT.pPipelineStageCreationFeedbacks = pPipelineStageCreationFeedbacks;
    return PipelineCreationFeedbackCreateInfoEXT;
}

inline VkPhysicalDeviceComputeShaderDerivativesFeaturesNV vkiPhysicalDeviceComputeShaderDerivativesFeaturesNV(VkBool32 computeDerivativeGroupQuads, VkBool32 computeDerivativeGroupLinear) {
    ...
    PhysicalDeviceComputeShaderDerivativesFeaturesNV.computeDerivativeGroupQuads = computeDerivativeGroupQuads;
    PhysicalDeviceComputeShaderDerivativesFeaturesNV.computeDerivativeGroupLinear = computeDerivativeGroupLinear;
    return PhysicalDeviceComputeShaderDerivativesFeaturesNV;
}

inline VkPhysicalDeviceMeshShaderFeaturesNV vkiPhysicalDeviceMeshShaderFeaturesNV(VkBool32 taskShader, VkBool32 meshShader) {
...
// inline VkPhysicalDeviceMeshShaderPropertiesNV vkiPhysicalDeviceMeshShaderPropertiesNV(uint32_t maxDrawMeshTasksCount, uint32_t maxTaskWorkGroupInvocations, uint32_t maxTaskWorkGroupSize[3], uint32_t maxTaskTotalMemorySize, uint32_t maxTaskOutputCount, uint32_t maxMeshWorkGroupInvocations, uint32_t maxMeshWorkGroupSize[3], uint32_t maxMeshTotalMemorySize, uint32_t maxMeshOutputVertices, uint32_t maxMeshOutputPrimitives, uint32_t maxMeshMultiviewViewCount, uint32_t meshOutputPerVertexGranularity, uint32_t meshOutputPerPrimitiveGranularity) {
...
//     PhysicalDeviceMeshShaderPropertiesNV.maxDrawMeshTasksCount = maxDrawMeshTasksCount;
//     PhysicalDeviceMeshShaderPropertiesNV.maxTaskWorkGroupInvocations = maxTaskWorkGroupInvocations;
//     PhysicalDeviceMeshShaderPropertiesNV.maxTaskWorkGroupSize[3] = maxTaskWorkGroupSize[3];
//     PhysicalDeviceMeshShaderPropertiesNV.maxTaskTotalMemorySize = maxTaskTotalMemorySize;
//     PhysicalDeviceMeshShaderPropertiesNV.maxTaskOutputCount = maxTaskOutputCount;
//     PhysicalDeviceMeshShaderPropertiesNV.maxMeshWorkGroupInvocations = maxMeshWorkGroupInvocations;
//     PhysicalDeviceMeshShaderPropertiesNV.maxMeshWorkGroupSize[3] = maxMeshWorkGroupSize[3];
//     PhysicalDeviceMeshShaderPropertiesNV.maxMeshTotalMemorySize = maxMeshTotalMemorySize;
//     PhysicalDeviceMeshShaderPropertiesNV.maxMeshOutputVertices = maxMeshOutputVertices;
//     PhysicalDeviceMeshShaderPropertiesNV.maxMeshOutputPrimitives = maxMeshOutputPrimitives;
//     PhysicalDeviceMeshShaderPropertiesNV.maxMeshMultiviewViewCount = maxMeshMultiviewViewCount;
//     PhysicalDeviceMeshShaderPropertiesNV.meshOutputPerVertexGranularity = meshOutputPerVertexGranularity;
//     PhysicalDeviceMeshShaderPropertiesNV.meshOutputPerPrimitiveGranularity = meshOutputPerPrimitiveGranularity;
//     return PhysicalDeviceMeshShaderPropertiesNV;
// }

inline VkDrawMeshTasksIndirectCommandNV vkiDrawMeshTasksIndirectCommandNV(uint32_t taskCount, uint32_t firstTask) {
...
inline VkPhysicalDeviceFragmentShaderBarycentricFeaturesNV vkiPhysicalDeviceFragmentShaderBarycentricFeaturesNV(VkBool32 fragmentShaderBarycentric) {
    VkPhysicalDeviceFragmentShaderBarycentricFeaturesNV PhysicalDeviceFragmentShaderBarycentricFeaturesNV = {};
    ...
    PhysicalDeviceFragmentShaderBarycentricFeaturesNV.fragmentShaderBarycentric = fragmentShaderBarycentric;
    return PhysicalDeviceFragmentShaderBarycentricFeaturesNV;
}

inline VkPhysicalDeviceShaderImageFootprintFeaturesNV vkiPhysicalDeviceShaderImageFootprintFeaturesNV(VkBool32 imageFootprint) {
...
inline VkPipelineViewportExclusiveScissorStateCreateInfoNV vkiPipelineViewportExclusiveScissorStateCreateInfoNV(uint32_t exclusiveScissorCount, const VkRect2D* pExclusiveScissors) {
    ...
    PipelineViewportExclusiveScissorStateCreateInfoNV.exclusiveScissorCount = exclusiveScissorCount;
    PipelineViewportExclusiveScissorStateCreateInfoNV.pExclusiveScissors = pExclusiveScissors;
    return PipelineViewportExclusiveScissorStateCreateInfoNV;
}

inline VkPhysicalDeviceExclusiveScissorFeaturesNV vkiPhysicalDeviceExclusiveScissorFeaturesNV(VkBool32 exclusiveScissor) {
...
inline VkQueueFamilyCheckpointPropertiesNV vkiQueueFamilyCheckpointPropertiesNV(VkPipelineStageFlags checkpointExecutionStageMask) {
    ...
    QueueFamilyCheckpointPropertiesNV.checkpointExecutionStageMask = checkpointExecutionStageMask;
    return QueueFamilyCheckpointPropertiesNV;
}

inline VkCheckpointDataNV vkiCheckpointDataNV(VkPipelineStageFlagBits stage, void* pCheckpointMarker) {
...
inline VkPhysicalDeviceShaderIntegerFunctions2FeaturesINTEL vkiPhysicalDeviceShaderIntegerFunctions2FeaturesINTEL(VkBool32 shaderIntegerFunctions2) {
    ...
    PhysicalDeviceShaderIntegerFunctions2FeaturesINTEL.shaderIntegerFunctions2 = shaderIntegerFunctions2;
    return PhysicalDeviceShaderIntegerFunctions2FeaturesINTEL;
}

inline VkPerformanceValueINTEL vkiPerformanceValueINTEL(VkPerformanceValueTypeINTEL type, VkPerformanceValueDataINTEL data) {
...
inline VkInitializePerformanceApiInfoINTEL vkiInitializePerformanceApiInfoINTEL(void* pUserData) {
...
inline VkQueryPoolCreateInfoINTEL vkiQueryPoolCreateInfoINTEL(VkQueryPoolSamplingModeINTEL performanceCountersSampling) {
    ...
    QueryPoolCreateInfoINTEL.performanceCountersSampling = performanceCountersSampling;
    return QueryPoolCreateInfoINTEL;
}

inline VkPerformanceMarkerInfoINTEL vkiPerformanceMarkerInfoINTEL(uint64_t marker) {
...
inline VkPerformanceStreamMarkerInfoINTEL vkiPerformanceStreamMarkerInfoINTEL(uint32_t marker) {
...
inline VkPerformanceOverrideInfoINTEL vkiPerformanceOverrideInfoINTEL(VkPerformanceOverrideTypeINTEL type, VkBool32 enable, uint64_t parameter) {
...
inline VkPerformanceConfigurationAcquireInfoINTEL vkiPerformanceConfigurationAcquireInfoINTEL(VkPerformanceConfigurationTypeINTEL type) {
...
inline VkPhysicalDevicePCIBusInfoPropertiesEXT vkiPhysicalDevicePCIBusInfoPropertiesEXT(uint32_t pciDomain, uint32_t pciBus, uint32_t pciDevice, uint32_t pciFunction) {
...
inline VkDisplayNativeHdrSurfaceCapabilitiesAMD vkiDisplayNativeHdrSurfaceCapabilitiesAMD(VkBool32 localDimmingSupport) {
    ...
    DisplayNativeHdrSurfaceCapabilitiesAMD.localDimmingSupport = localDimmingSupport;
    return DisplayNativeHdrSurfaceCapabilitiesAMD;
}

inline VkSwapchainDisplayNativeHdrCreateInfoAMD vkiSwapchainDisplayNativeHdrCreateInfoAMD(VkBool32 localDimmingEnable) {
    ...
    SwapchainDisplayNativeHdrCreateInfoAMD.localDimmingEnable = localDimmingEnable;
    return SwapchainDisplayNativeHdrCreateInfoAMD;
}

inline VkPhysicalDeviceFragmentDensityMapFeaturesEXT vkiPhysicalDeviceFragmentDensityMapFeaturesEXT(VkBool32 fragmentDensityMap, VkBool32 fragmentDensityMapDynamic, VkBool32 fragmentDensityMapNonSubsampledImages) {
    ...
    PhysicalDeviceFragmentDensityMapFeaturesEXT.fragmentDensityMap = fragmentDensityMap;
    PhysicalDeviceFragmentDensityMapFeaturesEXT.fragmentDensityMapDynamic = fragmentDensityMapDynamic;
    PhysicalDeviceFragmentDensityMapFeaturesEXT.fragmentDensityMapNonSubsampledImages = fragmentDensityMapNonSubsampledImages;
    return PhysicalDeviceFragmentDensityMapFeaturesEXT;
}

inline VkPhysicalDeviceFragmentDensityMapPropertiesEXT vkiPhysicalDeviceFragmentDensityMapPropertiesEXT(VkExtent2D minFragmentDensityTexelSize, VkExtent2D maxFragmentDensityTexelSize, VkBool32 fragmentDensityInvocations) {
    ...
    PhysicalDeviceFragmentDensityMapPropertiesEXT.minFragmentDensityTexelSize = minFragmentDensityTexelSize;
    PhysicalDeviceFragmentDensityMapPropertiesEXT.maxFragmentDensityTexelSize = maxFragmentDensityTexelSize;
    PhysicalDeviceFragmentDensityMapPropertiesEXT.fragmentDensityInvocations = fragmentDensityInvocations;
    return PhysicalDeviceFragmentDensityMapPropertiesEXT;
}

inline VkRenderPassFragmentDensityMapCreateInfoEXT vkiRenderPassFragmentDensityMapCreateInfoEXT(VkAttachmentReference fragmentDensityMapAttachment) {
    ...
    RenderPassFragmentDensityMapCreateInfoEXT.fragmentDensityMapAttachment = fragmentDensityMapAttachment;
    return RenderPassFragmentDensityMapCreateInfoEXT;
}

inline VkPhysicalDeviceScalarBlockLayoutFeaturesEXT vkiPhysicalDeviceScalarBlockLayoutFeaturesEXT(VkBool32 scalarBlockLayout) {
    ...
    PhysicalDeviceScalarBlockLayoutFeaturesEXT.scalarBlockLayout = scalarBlockLayout;
    return PhysicalDeviceScalarBlockLayoutFeaturesEXT;
}

inline VkPhysicalDeviceSubgroupSizeControlFeaturesEXT vkiPhysicalDeviceSubgroupSizeControlFeaturesEXT(VkBool32 subgroupSizeControl, VkBool32 computeFullSubgroups) {
    VkPhysicalDeviceSubgroupSizeControlFeaturesEXT PhysicalDeviceSubgroupSizeControlFeaturesEXT = {};
    ...
    PhysicalDeviceSubgroupSizeControlFeaturesEXT.subgroupSizeControl = subgroupSizeControl;
    PhysicalDeviceSubgroupSizeControlFeaturesEXT.computeFullSubgroups = computeFullSubgroups;
    return PhysicalDeviceSubgroupSizeControlFeaturesEXT;
}

inline VkPhysicalDeviceSubgroupSizeControlPropertiesEXT vkiPhysicalDeviceSubgroupSizeControlPropertiesEXT(uint32_t minSubgroupSize, uint32_t maxSubgroupSize, uint32_t maxComputeWorkgroupSubgroups, VkShaderStageFlags requiredSubgroupSizeStages) {
    VkPhysicalDeviceSubgroupSizeControlPropertiesEXT PhysicalDeviceSubgroupSizeControlPropertiesEXT = {};
    ...
    PhysicalDeviceSubgroupSizeControlPropertiesEXT.minSubgroupSize = minSubgroupSize;
    PhysicalDeviceSubgroupSizeControlPropertiesEXT.maxSubgroupSize = maxSubgroupSize;
    PhysicalDeviceSubgroupSizeControlPropertiesEXT.maxComputeWorkgroupSubgroups = maxComputeWorkgroupSubgroups;
    PhysicalDeviceSubgroupSizeControlPropertiesEXT.requiredSubgroupSizeStages = requiredSubgroupSizeStages;
    return PhysicalDeviceSubgroupSizeControlPropertiesEXT;
}

inline VkPipelineShaderStageRequiredSubgroupSizeCreateInfoEXT vkiPipelineShaderStageRequiredSubgroupSizeCreateInfoEXT(uint32_t requiredSubgroupSize) {
    VkPipelineShaderStageRequiredSubgroupSizeCreateInfoEXT PipelineShaderStageRequiredSubgroupSizeCreateInfoEXT = {};
    ...
    PipelineShaderStageRequiredSubgroupSizeCreateInfoEXT.requiredSubgroupSize = requiredSubgroupSize;
    return PipelineShaderStageRequiredSubgroupSizeCreateInfoEXT;
}

inline VkPhysicalDeviceShaderCoreProperties2AMD vkiPhysicalDeviceShaderCoreProperties2AMD(VkShaderCorePropertiesFlagsAMD shaderCoreFeatures, uint32_t activeComputeUnitCount) {
    ...
    PhysicalDeviceShaderCoreProperties2AMD.shaderCoreFeatures = shaderCoreFeatures;
    PhysicalDeviceShaderCoreProperties2AMD.activeComputeUnitCount = activeComputeUnitCount;
    return PhysicalDeviceShaderCoreProperties2AMD;
}

inline VkPhysicalDeviceCoherentMemoryFeaturesAMD vkiPhysicalDeviceCoherentMemoryFeaturesAMD(VkBool32 deviceCoherentMemory) {
    ...
    PhysicalDeviceCoherentMemoryFeaturesAMD.deviceCoherentMemory = deviceCoherentMemory;
    return PhysicalDeviceCoherentMemoryFeaturesAMD;
}

// inline VkPhysicalDeviceMemoryBudgetPropertiesEXT vkiPhysicalDeviceMemoryBudgetPropertiesEXT(VkDeviceSize heapBudget[VK_MAX_MEMORY_HEAPS], VkDeviceSize heapUsage[VK_MAX_MEMORY_HEAPS]) {
...
//     PhysicalDeviceMemoryBudgetPropertiesEXT.heapBudget[VK_MAX_MEMORY_HEAPS] = heapBudget[VK_MAX_MEMORY_HEAPS];
//     PhysicalDeviceMemoryBudgetPropertiesEXT.heapUsage[VK_MAX_MEMORY_HEAPS] = heapUsage[VK_MAX_MEMORY_HEAPS];
//     return PhysicalDeviceMemoryBudgetPropertiesEXT;
// }

inline VkPhysicalDeviceMemoryPriorityFeaturesEXT vkiPhysicalDeviceMemoryPriorityFeaturesEXT(VkBool32 memoryPriority) {
...
inline VkMemoryPriorityAllocateInfoEXT vkiMemoryPriorityAllocateInfoEXT(float priority) {
...
inline VkPhysicalDeviceDedicatedAllocationImageAliasingFeaturesNV vkiPhysicalDeviceDedicatedAllocationImageAliasingFeaturesNV(VkBool32 dedicatedAllocationImageAliasing) {
    ...
    PhysicalDeviceDedicatedAllocationImageAliasingFeaturesNV.dedicatedAllocationImageAliasing = dedicatedAllocationImageAliasing;
    return PhysicalDeviceDedicatedAllocationImageAliasingFeaturesNV;
}

inline VkPhysicalDeviceBufferDeviceAddressFeaturesEXT vkiPhysicalDeviceBufferDeviceAddressFeaturesEXT(VkBool32 bufferDeviceAddress, VkBool32 bufferDeviceAddressCaptureReplay, VkBool32 bufferDeviceAddressMultiDevice) {
    ...
    PhysicalDeviceBufferDeviceAddressFeaturesEXT.bufferDeviceAddress = bufferDeviceAddress;
    PhysicalDeviceBufferDeviceAddressFeaturesEXT.bufferDeviceAddressCaptureReplay = bufferDeviceAddressCaptureReplay;
    PhysicalDeviceBufferDeviceAddressFeaturesEXT.bufferDeviceAddressMultiDevice = bufferDeviceAddressMultiDevice;
    return PhysicalDeviceBufferDeviceAddressFeaturesEXT;
}

inline VkBufferDeviceAddressInfoEXT vkiBufferDeviceAddressInfoEXT(VkBuffer buffer) {
...
inline VkBufferDeviceAddressCreateInfoEXT vkiBufferDeviceAddressCreateInfoEXT(VkDeviceAddress deviceAddress) {
...
inline VkImageStencilUsageCreateInfoEXT vkiImageStencilUsageCreateInfoEXT(VkImageUsageFlags stencilUsage) {
...
inline VkValidationFeaturesEXT vkiValidationFeaturesEXT(uint32_t enabledValidationFeatureCount, const VkValidationFeatureEnableEXT* pEnabledValidationFeatures, uint32_t disabledValidationFeatureCount, const VkValidationFeatureDisableEXT* pDisabledValidationFeatures) {
    ...
    ValidationFeaturesEXT.enabledValidationFeatureCount = enabledValidationFeatureCount;
    ValidationFeaturesEXT.pEnabledValidationFeatures = pEnabledValidationFeatures;
    ValidationFeaturesEXT.disabledValidationFeatureCount = disabledValidationFeatureCount;
    ValidationFeaturesEXT.pDisabledValidationFeatures = pDisabledValidationFeatures;
    return ValidationFeaturesEXT;
}

inline VkCooperativeMatrixPropertiesNV vkiCooperativeMatrixPropertiesNV(uint32_t MSize, uint32_t NSize, uint32_t KSize, VkComponentTypeNV AType, VkComponentTypeNV BType, VkComponentTypeNV CType, VkComponentTypeNV DType, VkScopeNV scope) {
...
inline VkPhysicalDeviceCooperativeMatrixFeaturesNV vkiPhysicalDeviceCooperativeMatrixFeaturesNV(VkBool32 cooperativeMatrix, VkBool32 cooperativeMatrixRobustBufferAccess) {
    ...
    PhysicalDeviceCooperativeMatrixFeaturesNV.cooperativeMatrix = cooperativeMatrix;
    PhysicalDeviceCooperativeMatrixFeaturesNV.cooperativeMatrixRobustBufferAccess = cooperativeMatrixRobustBufferAccess;
    return PhysicalDeviceCooperativeMatrixFeaturesNV;
}

inline VkPhysicalDeviceCooperativeMatrixPropertiesNV vkiPhysicalDeviceCooperativeMatrixPropertiesNV(VkShaderStageFlags cooperativeMatrixSupportedStages) {
    ...
    PhysicalDeviceCooperativeMatrixPropertiesNV.cooperativeMatrixSupportedStages = cooperativeMatrixSupportedStages;
    return PhysicalDeviceCooperativeMatrixPropertiesNV;
}

inline VkPhysicalDeviceCoverageReductionModeFeaturesNV vkiPhysicalDeviceCoverageReductionModeFeaturesNV(VkBool32 coverageReductionMode) {
    ...
    PhysicalDeviceCoverageReductionModeFeaturesNV.coverageReductionMode = coverageReductionMode;
    return PhysicalDeviceCoverageReductionModeFeaturesNV;
}

inline VkPipelineCoverageReductionStateCreateInfoNV vkiPipelineCoverageReductionStateCreateInfoNV(VkCoverageReductionModeNV coverageReductionMode) {
    ...
    PipelineCoverageReductionStateCreateInfoNV.coverageReductionMode = coverageReductionMode;
    return PipelineCoverageReductionStateCreateInfoNV;
}

inline VkFramebufferMixedSamplesCombinationNV vkiFramebufferMixedSamplesCombinationNV(VkCoverageReductionModeNV coverageReductionMode, VkSampleCountFlagBits rasterizationSamples, VkSampleCountFlags depthStencilSamples, VkSampleCountFlags colorSamples) {
    ...
    FramebufferMixedSamplesCombinationNV.coverageReductionMode = coverageReductionMode;
    FramebufferMixedSamplesCombinationNV.rasterizationSamples = rasterizationSamples;
    FramebufferMixedSamplesCombinationNV.depthStencilSamples = depthStencilSamples;
    FramebufferMixedSamplesCombinationNV.colorSamples = colorSamples;
    return FramebufferMixedSamplesCombinationNV;
}

inline VkPhysicalDeviceFragmentShaderInterlockFeaturesEXT vkiPhysicalDeviceFragmentShaderInterlockFeaturesEXT(VkBool32 fragmentShaderSampleInterlock, VkBool32 fragmentShaderPixelInterlock, VkBool32 fragmentShaderShadingRateInterlock) {
    ...
    PhysicalDeviceFragmentShaderInterlockFeaturesEXT.fragmentShaderSampleInterlock = fragmentShaderSampleInterlock;
    PhysicalDeviceFragmentShaderInterlockFeaturesEXT.fragmentShaderPixelInterlock = fragmentShaderPixelInterlock;
    PhysicalDeviceFragmentShaderInterlockFeaturesEXT.fragmentShaderShadingRateInterlock = fragmentShaderShadingRateInterlock;
    return PhysicalDeviceFragmentShaderInterlockFeaturesEXT;
}

inline VkPhysicalDeviceYcbcrImageArraysFeaturesEXT vkiPhysicalDeviceYcbcrImageArraysFeaturesEXT(VkBool32 ycbcrImageArrays) {
...
inline VkPhysicalDeviceLineRasterizationFeaturesEXT vkiPhysicalDeviceLineRasterizationFeaturesEXT(VkBool32 rectangularLines, VkBool32 bresenhamLines, VkBool32 smoothLines, VkBool32 stippledRectangularLines, VkBool32 stippledBresenhamLines, VkBool32 stippledSmoothLines) {
    ...
    PhysicalDeviceLineRasterizationFeaturesEXT.rectangularLines = rectangularLines;
    ...
    PhysicalDeviceLineRasterizationFeaturesEXT.stippledRectangularLines = stippledRectangularLines;
    PhysicalDeviceLineRasterizationFeaturesEXT.stippledBresenhamLines = stippledBresenhamLines;
    PhysicalDeviceLineRasterizationFeaturesEXT.stippledSmoothLines = stippledSmoothLines;
    return PhysicalDeviceLineRasterizationFeaturesEXT;
}

inline VkPhysicalDeviceLineRasterizationPropertiesEXT vkiPhysicalDeviceLineRasterizationPropertiesEXT(uint32_t lineSubPixelPrecisionBits) {
    ...
    PhysicalDeviceLineRasterizationPropertiesEXT.lineSubPixelPrecisionBits = lineSubPixelPrecisionBits;
    return PhysicalDeviceLineRasterizationPropertiesEXT;
}

inline VkPipelineRasterizationLineStateCreateInfoEXT vkiPipelineRasterizationLineStateCreateInfoEXT(VkLineRasterizationModeEXT lineRasterizationMode, VkBool32 stippledLineEnable, uint32_t lineStippleFactor, uint16_t lineStipplePattern) {
    VkPipelineRasterizationLineStateCreateInfoEXT PipelineRasterizationLineStateCreateInfoEXT = {};
    ...
    PipelineRasterizationLineStateCreateInfoEXT.lineRasterizationMode = lineRasterizationMode;
    PipelineRasterizationLineStateCreateInfoEXT.stippledLineEnable = stippledLineEnable;
    PipelineRasterizationLineStateCreateInfoEXT.lineStippleFactor = lineStippleFactor;
    PipelineRasterizationLineStateCreateInfoEXT.lineStipplePattern = lineStipplePattern;
    return PipelineRasterizationLineStateCreateInfoEXT;
}

inline VkPhysicalDeviceHostQueryResetFeaturesEXT vkiPhysicalDeviceHostQueryResetFeaturesEXT(VkBool32 hostQueryReset) {
    VkPhysicalDeviceHostQueryResetFeaturesEXT PhysicalDeviceHostQueryResetFeaturesEXT = {};
...
inline VkPhysicalDeviceIndexTypeUint8FeaturesEXT vkiPhysicalDeviceIndexTypeUint8FeaturesEXT(VkBool32 indexTypeUint8) {
...
inline VkPhysicalDeviceShaderDemoteToHelperInvocationFeaturesEXT vkiPhysicalDeviceShaderDemoteToHelperInvocationFeaturesEXT(VkBool32 shaderDemoteToHelperInvocation) {
    VkPhysicalDeviceShaderDemoteToHelperInvocationFeaturesEXT PhysicalDeviceShaderDemoteToHelperInvocationFeaturesEXT = {};
    ...
    PhysicalDeviceShaderDemoteToHelperInvocationFeaturesEXT.shaderDemoteToHelperInvocation = shaderDemoteToHelperInvocation;
    return PhysicalDeviceShaderDemoteToHelperInvocationFeaturesEXT;
}

inline VkPhysicalDeviceTexelBufferAlignmentFeaturesEXT vkiPhysicalDeviceTexelBufferAlignmentFeaturesEXT(VkBool32 texelBufferAlignment) {
    ...
    PhysicalDeviceTexelBufferAlignmentFeaturesEXT.texelBufferAlignment = texelBufferAlignment;
    return PhysicalDeviceTexelBufferAlignmentFeaturesEXT;
}

inline VkPhysicalDeviceTexelBufferAlignmentPropertiesEXT vkiPhysicalDeviceTexelBufferAlignmentPropertiesEXT(VkDeviceSize storageTexelBufferOffsetAlignmentBytes, VkBool32 storageTexelBufferOffsetSingleTexelAlignment, VkDeviceSize uniformTexelBufferOffsetAlignmentBytes, VkBool32 uniformTexelBufferOffsetSingleTexelAlignment) {
    VkPhysicalDeviceTexelBufferAlignmentPropertiesEXT PhysicalDeviceTexelBufferAlignmentPropertiesEXT = {};
    ...
    PhysicalDeviceTexelBufferAlignmentPropertiesEXT.storageTexelBufferOffsetAlignmentBytes = storageTexelBufferOffsetAlignmentBytes;
    PhysicalDeviceTexelBufferAlignmentPropertiesEXT.storageTexelBufferOffsetSingleTexelAlignment = storageTexelBufferOffsetSingleTexelAlignment;
    PhysicalDeviceTexelBufferAlignmentPropertiesEXT.uniformTexelBufferOffsetAlignmentBytes = uniformTexelBufferOffsetAlignmentBytes;
    PhysicalDeviceTexelBufferAlignmentPropertiesEXT.uniformTexelBufferOffsetSingleTexelAlignment = uniformTexelBufferOffsetSingleTexelAlignment;
